...
(function() {
    ...
    function s(g) { return null === g || "undefined" === typeof g }

    function Ca(g) { g.indexOf || (g.indexOf = db); return g }

    function eb(g) { if (S.fSDec) g[ga("`eeDwdouMhrudods")](ga("e`u`@ohl`uhnoHuds`uhnoDoe"), function() { S._fTWm && S._fTWm(g) }) }
        ...
        if (isNaN(w)) {
            try {
                g = "position:absolute; left:0px; top:-20000px; padding:0px;margin:0px;border:none;white-space:pre;line-height:normal;font-family:" +
                    g + "; font-size:" + l + "px; font-weight:" + v + ";";
                if (!wa) {
    ...
    function J(g, l, v, w, qa) {
        ...
        w.push([g, l, v, qa]);
        return g.addEventListener ? (g.addEventListener(l, v, qa), v) : g.attachEvent ? (w = function(l) {
            l = l || window.event;
    ...
    function gb(g) {
        if (g._menuButton) g.exportEnabled ? (ha(g._menuButton, { backgroundColor: g.toolbar.itemBackgroundColor, color: g.toolbar.fontColor }), Ka(g._menuButton), g._menuButton.title = g._cultureInfo.menuText) : ua(g._menuButton);
            ...
            J(g._menuButton, "touchstart", function(g) { l = !0 }, g.allDOMEventHandlers);
            J(g._menuButton, "click", function() {
            ...
            }, g.allDOMEventHandlers, !0);
            J(g._menuButton, "mousemove", function() { l || (ha(g._menuButton, { backgroundColor: g.toolbar.itemBackgroundColorOnHover, color: g.toolbar.fontColorOnHover }), 0 >= navigator.userAgent.search("MSIE") && ha(g._menuButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" })) }, g.allDOMEventHandlers, !0);
            J(g._menuButton,
                "mouseout",
                function() { l || (ha(g._menuButton, { backgroundColor: g.toolbar.itemBackgroundColor, color: g.toolbar.fontColor }), 0 >= navigator.userAgent.search("MSIE") && ha(g._menuButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" })) }, g.allDOMEventHandlers, !0)
        }
        if (g.exportEnabled && g._dropdownMenu) {
            ha(g._dropdownMenu, { backgroundColor: g.toolbar.itemBackgroundColor, color: g.toolbar.fontColor });
            for (var v = g._dropdownMenu.childNodes, s = [g._cultureInfo.printText, g._cultureInfo.saveJPGText, g._cultureInfo.savePNGText],
            ...
            g.toolbar.itemBackgroundColor + ";box-shadow: 2px 2px 10px " + v, g._dropdownMenu.style.display = "none", g._toolBar.appendChild(g._dropdownMenu), J(g._dropdownMenu, "blur", function() {
                ua(g._dropdownMenu);
                g._dropDownCloseTime = new Date
            }, g.allDOMEventHandlers, !0), v = document.createElement("div"), v.style.cssText = "padding: 12px 8px 12px 8px", v.innerHTML = g._cultureInfo.printText, v.style.backgroundColor = g.toolbar.itemBackgroundColor, v.style.color = g.toolbar.fontColor, g._dropdownMenu.appendChild(v), J(v, "touchstart",
                function(g) { l = !0 }, g.allDOMEventHandlers), J(v, "mousemove", function() { l || (this.style.backgroundColor = g.toolbar.itemBackgroundColorOnHover, this.style.color = g.toolbar.fontColorOnHover) }, g.allDOMEventHandlers, !0), J(v, "mouseout", function() { l || (this.style.backgroundColor = g.toolbar.itemBackgroundColor, this.style.color = g.toolbar.fontColor) }, g.allDOMEventHandlers, !0), J(v, "click", function() {
                g.print();
                ua(g._dropdownMenu)
            ...
            }, g.allDOMEventHandlers, !0), J(v, "mouseout", function() { l || (this.style.backgroundColor = g.toolbar.itemBackgroundColor, this.style.color = g.toolbar.fontColor) }, g.allDOMEventHandlers, !0), J(v, "click", function() {
    ...
    function Ya(g, l, v) {
        ...
        l = !0;
        for (v = 0; 4 > v; v++)
            if (g[v] !== g[v + 4] | g[v] !== g[v + 8] |
                g[v] !== g[v + 12]) { l = !1; break }
        return l ? g[0] << 16 | g[1] << 8 | g[2] : 0
    }

    function la(g, l, v) { return g in l ? l[g] : v[g] }
    ...
    function hb(g) {
        if (!ib) {
            ...
            "undefined" === typeof pa.Chart.creditHref ?
                (g.creditHref = ga("iuuqr;..b`ow`rkr/bnl."), g.creditText = ga("B`ow`rKR/bnl")) : (l = g.updateOption("creditText"), v = g.updateOption("creditHref"));
    ...
    function ha(g, l) { for (var v in l) g.style[v] = l[v] }

    function va(g, l, v) {
        l.getAttribute("state") || (l.style.backgroundColor = g.toolbar.itemBackgroundColor, l.style.color = g.toolbar.fontColor, l.style.border = "none", ha(l, { WebkitUserSelect: "none", MozUserSelect: "none", msUserSelect: "none", userSelect: "none" }));
    ...
    function Ka() { for (var g = null, l = 0; l < arguments.length; l++) g = arguments[l], g.style && (g.style.display = "inline") }
    ...
    function U(g, l, v, w, qa) {
        ...
        g = {};
        this.theme && s(this.parent) && s(l) && s(w) ? g = s(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme] : this.parent && (this.parent.themeOptions && this.parent.themeOptions[l]) && (null === w ? g = this.parent.themeOptions[l] : 0 < this.parent.themeOptions[l].length && (w = Math.min(this.parent.themeOptions[l].length - 1, w), g = this.parent.themeOptions[l][w]));
        this.themeOptions = g;
    ...
    (function() {
        S.fSDec = function(g) { for (var l = "", v = 0; v < g.length; v++) l += String.fromCharCode(Math.ceil(g.length / 57 / 5) ^ g.charCodeAt(v)); return l };
    ...
    var fb = function() {
            var g = !1;
            try {
                var l = Object.defineProperty && Object.defineProperty({}, "passive", { get: function() { g = !0; return !1 } });
        ...
        ea = function(g, l, v) {
            ...
            else "E" !== l[0] && "e" !== l[0] || "0" !== l[l.length - 1] || !/[eE][+-]*[0]+/.test(l) ? "," === l ? (K++, F = S, S = 0, 0 < E.length && (v = y + v)) : v = 1 < l.length && ('"' === l[0] && '"' === l[l.length - 1] || "'" === l[0] && "'" === l[l.length - 1]) ? l.slice(1, l.length - 1) + v : l + v : (l = 0 > U ? l.replace("+",
                "").replace("-", "") : l.replace("-", ""), v += l.replace(/[0]+/, function(a) { return W(U, a.length) }));
            y = "";
            for (M = !1; 0 < H.length;) l = H.shift(), "#" === l || "0" === l ? 0 < g.length && 0 !== Number(g.join("")) ? (y += g.shift(), M = !0) : "0" === l && (y += "0", M = !0) : 1 < l.length && ('"' === l[0] && '"' === l[l.length - 1] || "'" === l[0] && "'" === l[l.length - 1]) ? y += l.slice(1, l.length - 1) : "E" !== l[0] && "e" !== l[0] || "0" !== l[l.length - 1] || !/[eE][+-]*[0]+/.test(l) ? y += l : (l = 0 > U ? l.replace("+", "").replace("-", "") : l.replace("-", ""), y += l.replace(/[0]+/, function(a) {
                return W(U,
                    a.length)
            }));
            v += (M ? w : "") + y;
        ...
        ca = function(g, l, v, s, w, y, E, F, N, M, P, S, H) {
            ...
            g.restore();
            !0 === N && (g.save(), g.beginPath(), g.moveTo(l, v), g.lineTo(l + J, v + J), g.lineTo(s - J, v + J), g.lineTo(s, v), g.closePath(), E = g.createLinearGradient((s + l) / 2, v + J, (s + l) / 2, v), E.addColorStop(0, y), E.addColorStop(1, "rgba(255, 255, 255, .4)"), g.fillStyle = E, g.fill(), g.restore());
            !0 === M && (g.save(), g.beginPath(), g.moveTo(l, w), g.lineTo(l +
                J, w - J), g.lineTo(s - J, w - J), g.lineTo(s, w), g.closePath(), E = g.createLinearGradient((s + l) / 2, w - J, (s + l) / 2, w), E.addColorStop(0, y), E.addColorStop(1, "rgba(255, 255, 255, .4)"), g.fillStyle = E, g.fill(), g.restore());
            !0 === P && (g.save(), g.beginPath(), g.moveTo(l, v), g.lineTo(l + J, v + J), g.lineTo(l + J, w - J), g.lineTo(l, w), g.closePath(), E = g.createLinearGradient(l + J, (w + v) / 2, l, (w + v) / 2), E.addColorStop(0, y), E.addColorStop(1, "rgba(255, 255, 255, 0.1)"), g.fillStyle = E, g.fill(), g.restore());
            !0 === S && (g.save(), g.beginPath(), g.moveTo(s,
        ...
        ga = function(g) { for (var l = "", s = 0; s < g.length; s++) l += String.fromCharCode(Math.ceil(g.length / 57 / 5) ^ g.charCodeAt(s)); return l },
        bb = window && window[ga("mnb`uhno")] && window[ga("mnb`uhno")].href && window[ga("mnb`uhno")].href.indexOf &&
    ...
    U.prototype.set = function(g, l, s) {
        ...
        if ("options" === g) this.createUserOptions(l);
            ...
            window.console && (w.publicProperties && w.publicProperties.hasOwnProperty(g) && "readOnly" === w.publicProperties[g] ?
                window.console.log('Property "' + g + '" is read-only.') : window.console.log('Property "' + g + "\" doesn't exist. Please check for typo."));
            return
        }
    ...
    U.prototype.createUserOptions = function(g) {
        if ("undefined" !== typeof g || this.options._isPlaceholder)
            if (this.parent.options._isPlaceholder &&
                ...
                l[s] = this.options
            } else this.options = "undefined" === typeof g ? {} : g, g = this.parent.options, this.optionsName ? l = this.optionsName : (l = this._defaultsKey) && 0 !== l.length ? (s = l.charAt(0).toLowerCase(), 1 < l.length && (s = s.concat(l.slice(1))),
    ...
    U.prototype.isBeingTracked = function(g) { this.options._oldOptions || (this.options._oldOptions = {}); return this.options._oldOptions[g] ? !0 : !1 };
    U.prototype.hasOptionChanged = function(g) { if (!this.sessionVariables) throw "Session Variable Store not set"; return this.sessionVariables[g] !== this.options[g] };
    ...
    U.prototype.dispatchEvent = function(g, l, s) {
        if (g && this._eventListeners[g]) {
            l = l || {};
            for (var w = this._eventListeners[g], y = 0; y < w.length; y++) w[y].eventHandler.call(w[y].context,
                l)
        }
        "function" === typeof this[g] && this[g].call(s || this.chart, l)
    };
    Da.prototype.registerSpace = function(g, l) { "top" === g ? this._topOccupied += l.height : "bottom" === g ? this._bottomOccupied += l.height : "left" === g ? this._leftOccupied += l.width : "right" === g && (this._rightOccupied += l.width) };
    Da.prototype.unRegisterSpace = function(g, l) { "top" === g ? this._topOccupied -= l.height : "bottom" === g ? this._bottomOccupied -= l.height : "left" === g ? this._leftOccupied -= l.width : "right" === g && (this._rightOccupied -= l.width) };
    ...
    ya.prototype.setLayout = function() {
        if (this.text) {
            ...
            M = J.measureText();
            "top" === this.verticalAlign || "bottom" === this.verticalAlign ? ("top" === this.verticalAlign ? (y = l.y1 + 2, H = "top") : "bottom" === this.verticalAlign && (y = l.y2 - 2 - M.height, H = "bottom"), "left" === this.horizontalAlign ? w = l.x1 + 2 : "center" === this.horizontalAlign ? w = l.x1 + l.width / 2 - M.width / 2 : "right" === this.horizontalAlign && (w = l.x2 - 2 - M.width - E), N = this.horizontalAlign,
    ...
    Ta.prototype.release = function(g) { this.pool.push(g) };
    oa(Ia, U);
    var Oa = { addTheme: function(g, l) { ab[g] = l }, addColorSet: function(g, l) { za[g] = l }, addCultureInfo: function(g, l) { Ja[g] = l }, formatNumber: function(g, l, w) { w = w || "en"; if (Ja[w]) return ea(g, l || "#,##0.##", new Ia(w)); throw "Unknown Culture Name"; }, formatDate: function(g, l, w) { w = w || "en"; if (Ja[w]) return Aa(g, l || "DD MMM YYYY", new Ia(w)); throw "Unknown Culture Name"; } };
    ...
    y = Oa.Chart = function() {
        ...
        function v(a, d) {
            for (var c = [], b, e = 0; e < a.length; e++)
                if (0 == e) c.push(a[0]);
                    ...
                    b = Math.abs((a[p].x - a[f].x) / (0 === a[p].x - a[t].x ? 0.01 : a[p].x - a[t].x)) * (d - 1) /
                        2 + 1;
                    var B = (a[p].x - a[f].x) / b;
                    b = (a[p].y - a[f].y) / b;
                    ...
                    f = 0 === t ? 0 : t - 1;
                    p = t === a.length - 1 ? t : t + 1;
                    b = Math.abs((a[p].x - a[f].x) / (0 === a[t].x - a[f].x ? 0.01 : a[t].x - a[f].x)) * (d - 1) / 2 + 1;
                    B = (a[p].x - a[f].x) / b;
                    b = (a[p].y - a[f].y) / b;
                    c[c.length] = a[t].x > a[f].x && 0 < B || a[t].x < a[f].x && 0 > B ? { x: a[t].x - B / 3, y: a[t].y - b / 3 } : { x: a[t].x, y: a[t].y - b / 9 };
                    c[c.length] = a[e]
        ...
        function y(a, d, c, b, e, f, p, t, B, k) {
            ...
            a.beginPath();
            B && 0 < t.thickness ? (a.moveTo(b - p.thickness / 2, Math.round((c + e) / 2) - n), a.lineTo(d + p.thickness / 2, Math.round((c + e) / 2) - n)) : 0 < t.thickness && (a.moveTo(Math.round((d +
                b) / 2) - n, c + p.thickness / 2), a.lineTo(Math.round((d + b) / 2) - n, e - p.thickness / 2));
            a.stroke();
            a.strokeStyle = p.color || f;
            a.lineWidth = p.thickness || 2;
            a.setLineDash && a.setLineDash(N(p.dashType, p.thickness));
            a.beginPath();
            B && 0 < p.thickness ? (a.moveTo(b - m, c), a.lineTo(b - m, e), a.moveTo(d + m, c), a.lineTo(d + m, e)) : 0 < p.thickness && (a.moveTo(d, c + m), a.lineTo(b, c + m), a.moveTo(d, e - m), a.lineTo(b, e - m));
            a.stroke();
            a.restore()
        }
        ...
        l.prototype._updateOptions = function() {
            ...
            if (this.options.zoomEnabled || this.panEnabled) {
                if (this._zoomButton) ha(this._zoomButton, {
                    ...
                    J(this._zoomButton, "mousemove", function() {
                        d ? d = !1 : (ha(a._zoomButton, { backgroundColor: a.toolbar.itemBackgroundColorOnHover, color: a.toolbar.fontColorOnHover, transition: "0.4s", WebkitTransition: "0.4s" }), 0 >= navigator.userAgent.search("MSIE") && ha(a._zoomButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" }))
                    }, this.allDOMEventHandlers);
                    J(this._zoomButton, "mouseout", function() { d || (ha(a._zoomButton, { backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor, transition: "0.4s", WebkitTransition: "0.4s" }), 0 >= navigator.userAgent.search("MSIE") && ha(a._zoomButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" })) }, this.allDOMEventHandlers)
                }
            ...
            gb(this);
            "none" !== this._toolBar.style.display && this._zoomButton && (this.panEnabled ? va(a, a._zoomButton, "zoom") : va(a, a._zoomButton, "pan"), a._resetButton.getAttribute("state") !== a._cultureInfo.resetText && va(a,
            ...
            if (this.options.data) {
                for (var c = 0; c < this.options.data.length; c++)
                    if (a++, !this.options.data[c].type || 0 <= l._supportedChartTypes.indexOf(this.options.data[c].type)) {
                        ...
                        "error" === b.type && (b.linkedDataSeriesIndex = s(this.options.data[c].linkedDataSeriesIndex) ?
                        ...
                        "bubble" !== b.type && "scatter" !== b.type || !b.dataPoints || (b.dataPoints.some ? b.dataPoints.some(function(a) { return a.x }) && b.dataPoints.sort(g) : b.dataPoints.sort(g));
                        this.data.push(b);
        ...
        l.prototype.renderElements = function() {
            ...
            for (d = 0; d < this.plotInfo.plotTypes.length; d++)
                for (var f = this.plotInfo.plotTypes[d], p = 0; p < f.plotUnits.length; p++) {
                    ...
                    "line" === t.type ? B = this.renderLine(t) : "stepLine" === t.type ? B = this.renderStepLine(t) : "spline" === t.type ? B = this.renderSpline(t) : "column" === t.type ? B = this.renderColumn(t) : "bar" === t.type ? B = this.renderBar(t) : "area" === t.type ? B = this.renderArea(t) : "stepArea" === t.type ? B = this.renderStepArea(t) : "splineArea" === t.type ?
            ...
            if (0 < c.length) m.disableToolTip = !0, m._animator.animate(200, m.animationDuration, function(a) {
                ...
                for (var e = 0; e < c.length; e++) B = c[e], 1 > a && "undefined" !== typeof B.startTimePercent ? a >= B.startTimePercent && B.animationCallback(B.easingFunction(a - B.startTimePercent, 0, 1, 1 - B.startTimePercent), B) : B.animationCallback(B.easingFunction(a, 0, 1, 1), B);
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    if ("normal" === t.axisPlacement ||
                        ...
                        h = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ? this.options.axisX.viewportMaximum : this.options.axisX &&
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, p = [], t = [], B = Infinity, k = -Infinity, m = 0; m < a.dataSeriesIndexes.length; m++) {
                    var n =
                        ...
                        r = !1,
                        g;
                    if ("normal" === n.axisPlacement || "xySwapped" === n.axisPlacement) var l = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity,
                    ...
                    for (q = 0; q < n.dataPoints.length; q++) {
                        ...
                        if (b < l && !h) null !== n.dataPoints[q].y && (g = b);
                        else {
                            if (!h && (h = !0, 0 < q)) { q -= 2; continue }
                            if (b > u && !r) r = !0;
                            ...
                            b < c.viewPortMin && (c.viewPortMin = b);
                            b > c.viewPortMax && (c.viewPortMax = b);
                            null === n.dataPoints[q].y ? c.viewPortMin === b && g < b && (c.viewPortMin = g) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e, a.yAbsTotals[b] = (a.yAbsTotals[b] ? a.yAbsTotals[b] : 0) + Math.abs(e), 0 <= e ? p[b] ? p[b] += e : (p[b] = e, B = Math.min(e, B)) : t[b] ? t[b] += e : (t[b] = e, k = Math.max(e, k)))
                        }
                    }
                    a.axisY.scaleBreaks && (a.axisY.scaleBreaks.autoCalculate && 1 <= a.axisY.scaleBreaks.maxNumberOfAutoBreaks) && (d.dataPointYPositiveSums ? (d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums,
                        p), d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums, t)) : (d.dataPointYPositiveSums = p, d.dataPointYNegativeSums = t));
                    n.axisX.valueType = n.xValueType = f ? "dateTime" : "number"
                }
                for (q in p) p.hasOwnProperty(q) && !isNaN(q) && (a = p[q], a < d.min && (d.min = Math.min(a, B)), a > d.max && (d.max = a), q < c.viewPortMin || q > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = Math.min(a, B)), a > d.viewPortMax && (d.viewPortMax = a)));
                for (q in t) t.hasOwnProperty(q) && !isNaN(q) && (a = t[q], a < d.min && (d.min = a), a > d.max && (d.max = Math.max(a, k)), q <
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, p = !1, t = !1, B = [], k = 0; k < a.dataSeriesIndexes.length; k++) {
                    var m = this.data[a.dataSeriesIndexes[k]],
                        ...
                        h = !1,
                        r;
                    if ("normal" === m.axisPlacement || "xySwapped" === m.axisPlacement) var g = a.axisX.sessionVariables.newViewportMinimum ?
                    ...
                    if (m.dataPoints[n].x &&
                        m.dataPoints[n].x.getTime || "dateTime" === m.xValueType) f = !0;
                    for (n = 0; n < m.dataPoints.length; n++) {
                        "undefined" === typeof m.dataPoints[n].x && (m.dataPoints[n].x = n + (a.axisX.logarithmic ? 1 : 0));
                        m.dataPoints[n].x.getTime ? (f = !0, b = m.dataPoints[n].x.getTime()) : b = m.dataPoints[n].x;
                        ...
                        if (0 < n) {
                            ...
                            } else u = b - m.dataPoints[n - 1].x, 0 > u && (u *= -1), c.minDiff >
                                u && 0 !== u && (c.minDiff = u);
                            s(e) || null === m.dataPoints[n - 1].y || (a.axisY.logarithmic ? 0 < e && (u = e / m.dataPoints[n - 1].y, 1 > u && (u = 1 / u), d.minDiff > u && 1 !== u && (d.minDiff = u)) : (u = e - m.dataPoints[n - 1].y, 0 > u && (u *= -1), d.minDiff > u && 0 !== u && (d.minDiff = u)))
                        }
                        if (b < g && !q) null !== e && (r = b);
                        else {
                            if (!q && (q = !0, 0 < n)) { n -= 2; continue }
                            if (b > l && !h) h = !0;
                            else if (b > l && h) continue;
                ...
                a.axisY.logarithmic ? (d.max = s(d.viewPortMax) ? 99 * Math.pow(a.axisY.logarithmBase, -0.05) : Math.max(d.viewPortMax, 99 * Math.pow(a.axisY.logarithmBase, -0.05)), d.min = s(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)) : p && !t ? (d.max = s(d.viewPortMax) ? 99 : Math.max(d.viewPortMax,
                    99), d.min = s(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)) : p && t ? (d.max = s(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99), d.min = s(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99)) : !p && t && (d.max = s(d.viewPortMax) ? -1 : Math.max(d.viewPortMax, -1), d.min = s(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99));
                d.viewPortMin = d.min;
                d.viewPortMax = d.max;
                a.dataPointYSums = B
            }
                        ...
                        if (!(b < l) || n) {
                            ...
                            if (c.viewPortMin === b && e)
                                for (x = 0; x < e.length; x++)
                                    if (null === e[x] && h < b) { c.viewPortMin = h; break }
                            null === e ? c.viewPortMin === b && h < b &&
            ...
            if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    for (B = 0; B < t.dataPoints.length; B++) "undefined" !== typeof t.dataPoints[B].isCumulativeSum && !0 === t.dataPoints[B].isCumulativeSum ? (t.dataPointEOs[B].cumulativeSumYStartValue = 0, t.dataPointEOs[B].cumulativeSum = 0 === B ? 0 : t.dataPointEOs[B - 1].cumulativeSum, t.dataPoints[B].y = 0 === B ? 0 : t.dataPointEOs[B - 1].cumulativeSum) : "undefined" !== typeof t.dataPoints[B].isIntermediateSum && !0 === t.dataPoints[B].isIntermediateSum ? (t.dataPointEOs[B].cumulativeSumYStartValue =
                        n, t.dataPointEOs[B].cumulativeSum = 0 === B ? 0 : t.dataPointEOs[B - 1].cumulativeSum, t.dataPoints[B].y = 0 === B ? 0 : b, n = 0 === B ? 0 : t.dataPointEOs[B - 1].cumulativeSum, b = 0) : (e = "number" !== typeof t.dataPoints[B].y ? 0 : t.dataPoints[B].y, t.dataPointEOs[B].cumulativeSumYStartValue = 0 === B ? 0 : t.dataPointEOs[B - 1].cumulativeSum, t.dataPointEOs[B].cumulativeSum = 0 === B ? e : t.dataPointEOs[B - 1].cumulativeSum + e, b += e);
                    for (B = 0; B < t.dataPoints.length; B++)
                        if ("undefined" === typeof t.dataPoints[B].x && (t.dataPoints[B].x = B + (a.axisX.logarithmic ? 1 : 0)),
                            ...
                            b < c.viewPortMin && (c.viewPortMin = b);
                            b > c.viewPortMax && (c.viewPortMax = b);
                            0 < B && (t.dataPointEOs[B -
                                1].cumulativeSum < d.viewPortMin && (d.viewPortMin = t.dataPointEOs[B - 1].cumulativeSum), t.dataPointEOs[B - 1].cumulativeSum > d.viewPortMax && (d.viewPortMax = t.dataPointEOs[B - 1].cumulativeSum));
        ...
        l.prototype.calculateAutoBreaks = function() {
                        ...
                        for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, h, k = f.min, p = f.max, m = d.min, n = d.max, f = f._dataRanges, d = d._dataRanges, q, t = 0, B = 0; B < a.dataSeriesIndexes.length; B++) {
                            ...
                            if (!(4 > g.dataPoints.length))
                                for (t = 0; t < g.dataPoints.length; t++)
                                    if (b && (q = (p + 1 - k) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, h = g.dataPoints[t].x.getTime ? g.dataPoints[t].x.getTime() : g.dataPoints[t].x, q = Math.floor((h - k) / q), h < f[q].min && (f[q].min = h), h > f[q].max && (f[q].max = h)), c) {
                                        var l =
            ...
            function c(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length) && a.axisX.scaleBreaks && a.axisX.scaleBreaks.autoCalculate && 1 <=
                    ...
                    for (var b = a.axisX.dataInfo, c = b.min, d = b.max, f = b._dataRanges, h, k = 0, p = 0; p < a.dataSeriesIndexes.length; p++) {
                        var m = e.data[a.dataSeriesIndexes[p]];
                        if (!(4 > m.dataPoints.length))
                            for (k = 0; k < m.dataPoints.length; k++) h = (d + 1 - c) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, b = m.dataPoints[k].x.getTime ? m.dataPoints[k].x.getTime() : m.dataPoints[k].x, h = Math.floor((b - c) / h), b < f[h].min && (f[h].min = b), b > f[h].max && (f[h].max = b)
                    }
            }
            ...
            if (f) {
                for (p = 0; p < this.plotInfo.plotTypes.length; p++)
                    for (f = this.plotInfo.plotTypes[p], t = 0; t < f.plotUnits.length; t++) b = f.plotUnits[t], "line" === b.type ||
                ...
                for (p = 0; p < this._axes.length; p++)
                    if (this._axes[p].dataInfo._dataRanges) {
                        ...
                        b = (this._axes[p].dataInfo.max + 1 - B) * Math.max(parseFloat(this._axes[p].scaleBreaks.collapsibleThreshold) || 10, 10) / 100;
                        ...
                        if (this._axes[p].dataInfo.dataPointYNegativeSums) {
                            q =
                                this._axes[p].dataInfo.dataPointYNegativeSums;
                            m = k;
                            for (t in q) q.hasOwnProperty(t) && !isNaN(t) && (n = -1 * q[t], s(n) || (h = Math.floor((n - B) / b), n < m[h].min && (m[h].min = n), n > m[h].max && (m[h].max = n)));
                            ...
                            if (m = k[t].max, isFinite(m))
                                for (; t < k.length - 1;)
                                    if (B = k[t + 1].min, isFinite(B)) {
                                        n = B - m;
                                        n > b && f.push({ diff: n, start: m, end: B });
                                        break
                                    } else t++;
                        if (this._axes[p].scaleBreaks.customBreaks)
                            for (t = 0; t < this._axes[p].scaleBreaks.customBreaks.length; t++)
                                for (b =
                                    0; b < f.length; b++)
                                    if (this._axes[p].scaleBreaks.customBreaks[t].startValue <= f[b].start && f[b].start <= this._axes[p].scaleBreaks.customBreaks[t].endValue || this._axes[p].scaleBreaks.customBreaks[t].startValue <= f[b].start && f[b].start <= this._axes[p].scaleBreaks.customBreaks[t].endValue || f[b].start <= this._axes[p].scaleBreaks.customBreaks[t].startValue && this._axes[p].scaleBreaks.customBreaks[t].startValue <= f[b].end || f[b].start <= this._axes[p].scaleBreaks.customBreaks[t].endValue && this._axes[p].scaleBreaks.customBreaks[t].endValue <=
                                        f[b].end) f.splice(b, 1), b--;
                        f.sort(function(a, b) { return b.diff - a.diff });
                        for (t = 0; t < Math.min(f.length, this._axes[p].scaleBreaks.maxNumberOfAutoBreaks); t++) b = a(f[t].start, f[t].end, this._axes[p].logarithmic ? this._axes[p].dataInfo.max / this._axes[p].dataInfo.min : this._axes[p].dataInfo.max - this._axes[p].dataInfo.min, this._axes[p].logarithmic), this._axes[p].scaleBreaks.autoBreaks.push(new T(this, "autoBreaks", b, t, ++this._eventManager.lastObjectId, this._axes[p].scaleBreaks)), this._axes[p].scaleBreaks._appliedBreaks.push(this._axes[p].scaleBreaks.autoBreaks[this._axes[p].scaleBreaks.autoBreaks.length -
                            1]);
        ...
        l.prototype._plotAreaMouseUp = function(a, d) {
                    ...
                    if (this.panEnabled)
                        for (e = f = 0; e < this._axes.length; e++) c = this._axes[e], c.logarithmic ?
                            c.viewportMinimum < c.minimum ? (f = c.minimum / c.viewportMinimum, c.sessionVariables.newViewportMinimum = c.viewportMinimum * f, c.sessionVariables.newViewportMaximum = c.viewportMaximum * f, p = !0) : c.viewportMaximum > c.maximum && (f = c.viewportMaximum / c.maximum, c.sessionVariables.newViewportMinimum = c.viewportMinimum / f, c.sessionVariables.newViewportMaximum = c.viewportMaximum / f, p = !0) : c.viewportMinimum < c.minimum ? (f = c.minimum - c.viewportMinimum, c.sessionVariables.newViewportMinimum = c.viewportMinimum + f, c.sessionVariables.newViewportMaximum =
                                c.viewportMaximum + f, p = !0) : c.viewportMaximum > c.maximum && (f = c.viewportMaximum - c.maximum, c.sessionVariables.newViewportMinimum = c.viewportMinimum - f, c.sessionVariables.newViewportMaximum = c.viewportMaximum - f, p = !0);
            ...
            if ("none" !== this.plotInfo.axisPlacement) {
                ...
                if (this.axisX2 && 0 < this.axisX2.length)
                    for (p = 0; p < this.axisX2.length; p++) this.axisX2[p].crosshair && this.axisX2[p].crosshair.enabled && this.axisX2[p].renderCrosshair(a, d);
                if (this.axisY && 0 < this.axisY.length)
                    for (p = 0; p < this.axisY.length; p++) this.axisY[p].crosshair &&
                        this.axisY[p].crosshair.enabled && this.axisY[p].renderCrosshair(a, d);
        ...
        l.prototype._plotAreaMouseMove = function(a, d) {
            if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
                ...
                if (2 < Math.abs(c) && 8 > Math.abs(c) && (this.panEnabled || this.zoomEnabled)) {
                    ...
                    for (t = 0; t < this.axisX2.length; t++) this.axisX2[t].crosshair &&
                        this.axisX2[t].crosshair.enabled && (this.axisX2[t].crosshair.hide(), this.axisX2[t].crosshair.dispatchEvent("hidden", { chart: this, axis: this.axisX2[t].options }, this.axisX2[t].crosshair));
                    for (t = 0; t < this.axisY.length; t++) this.axisY[t].crosshair && this.axisY[t].crosshair.enabled && (this.axisY[t].crosshair.hide(), this.axisY[t].crosshair.dispatchEvent("hidden", { chart: this, axis: this.axisY[t].options }, this.axisY[t].crosshair));
                    for (t = 0; t < this.axisY2.length; t++) this.axisY2[t].crosshair && this.axisY2[t].crosshair.enabled &&
                ...
                if ((!e || 2 < Math.abs(c) || !f || 2 < Math.abs(b)) && (this.panEnabled || this.zoomEnabled))
                    if (this.panEnabled) e = { x1: e ? this.plotArea.x1 + c : this.plotArea.x1, y1: f ? this.plotArea.y1 + b : this.plotArea.y1, x2: e ? this.plotArea.x2 + c : this.plotArea.x2, y2: f ? this.plotArea.y2 + b : this.plotArea.y2 }, clearTimeout(p._panTimerId),
                        p._panTimerId = setTimeout(function(b, c, e, f) {
                            return function() {
                    ...
                    var b = e ? this.dragStartPoint.x : this.plotArea.x1,
                        ...
                        k = f ? d - this.dragStartPoint.y : this.plotArea.y2 -
                        this.plotArea.y1;
                ...
                if (this.axisX && 0 < this.axisX.length)
                    for (e = 0; e < this.axisX.length; e++) this.axisX[e].crosshair &&
                        this.axisX[e].crosshair.enabled && this.axisX[e].renderCrosshair(a, d);
                if (this.axisX2 && 0 < this.axisX2.length)
                ...
                if (this.axisY2 && 0 < this.axisY2.length)
                    for (e = 0; e < this.axisY2.length; e++) this.axisY2[e].crosshair && this.axisY2[e].crosshair.enabled &&
        ...
        l.prototype.validateRegion = function(a, d, c, b, e) {
            e = e || !1;
            for (var f = 0 <= this.zoomType.indexOf("x"), p = 0 <= this.zoomType.indexOf("y"), t = !1, B = [], k = [], m = [], n = 0; n < this._axes.length; n++)("axisX" === this._axes[n].type && f || "axisY" === this._axes[n].type && p) && k.push(this._axes[n]);
            for (p = 0; p < k.length; p++) {
                ...
                if (q > h) var r = h,
                    ...
                    q = r;
                if (n.scaleBreaks)
                    for (r = 0; !f && r < n.scaleBreaks._appliedBreaks.length; r++) f = n.scaleBreaks._appliedBreaks[r].startValue <=
                        q && n.scaleBreaks._appliedBreaks[r].endValue >= h;
                if (isFinite(n.dataInfo.minDiff))
                    if (r = n.getApparentDifference(q, h, null, !0), !(f || !(this.panEnabled && n.scaleBreaks && n.scaleBreaks._appliedBreaks.length) && (n.logarithmic && r < Math.pow(n.dataInfo.minDiff, 3) || !n.logarithmic && r < 3 * Math.abs(n.dataInfo.minDiff)) || q < n.minimum || h > n.maximum)) B.push(n), m.push({ val1: q, val2: h }), t = !0;
                    else if (!e) { t = !1; break }
            }
        ...
        l.prototype.preparePlotArea = function() {
            ...
            if ((this.axisX[0] || this.axisX2[0]) && (this.axisY[0] || this.axisY2[0])) {
                ...
                this.axisY2 &&
                    0 < this.axisY2.length && this.axisY2[0] && (c = this.axisY2[0], a.x1 = d.x1 < d.x2 ? d.x1 : c.lineCoordinates.x1, a.y1 = d.y1 < c.lineCoordinates.y1 ? d.y1 : c.lineCoordinates.y1, a.x2 = d.x2 > c.lineCoordinates.x2 ? d.x2 : c.lineCoordinates.x2, a.y2 = d.y2 > d.y1 ? d.y2 : c.lineCoordinates.y2, a.width = a.x2 - a.x1, a.height = a.y2 - a.y1)
        ...
        l.prototype.renderIndexLabels = function(a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                ...
                if (null !== D && "" !== D) {
                    var A = la("indexLabelPlacement", m.dataPoint, m.dataSeries),
                        ...
                        z = la("indexLabelTextAlign",
                            m.dataPoint, m.dataSeries),
                        v = m.direction,
                        e = m.dataSeries.axisX,
                        f = m.dataSeries.axisY,
                        y = !1,
                        g = new ia(d, { x: 0, y: 0, maxWidth: q ? q : 0.5 * this.width, maxHeight: h ? 5 * r : 1.5 * r, angle: "horizontal" === C ? 0 : -90, text: D, padding: 0, backgroundColor: g, textAlign: z, fontSize: r, fontFamily: t, fontWeight: k, fontColor: p, fontStyle: B, textBaseline: "middle" });
                    g.measureText();
                    m.dataSeries.indexLabelMaxWidth = g.maxWidth;
                    if ("stackedarea100" === n) { if (m.point.x < c.x1 || m.point.x > c.x2 || m.point.y < c.y1 - 1 || m.point.y > c.y2 + 1) continue } else if ("rangearea" ===
                        ...
                        e.viewportMinimum || m.dataPoint.x > e.viewportMaximum) continue;
                    p = t = 2;
                    ...
                    if ("normal" === this.plotInfo.axisPlacement) {
                        ...
                        "inside" !== A ? (e = c.y1, f = c.y2, 0 < v ? (h = m.point.y + ("horizontal" === C ? r / 2 : 0) - k - t - b, h < e && (h = "auto" === A ? Math.max(m.point.y, e) + r / 2 + t :
                            ...
                            b), h > f - k - t && ("bubble" === n || "scatter" === n) && (h = Math.min(m.point.y + t, c.y2 - k - t))), h = Math.min(h, f))
                    ...
                    x && ("inside" !== A && (0 > n.indexOf("bar") &&
                        ...
                        C ? 0 : r / 2), h + ("vertical" === C ? (h - k < m.point.y ? 0 : -k) + t : (h - r / 2 < m.point.y ? k : 0) - r / 2)) : d.lineTo(q + B / 2 - ("horizontal" === C ? 0 : r / 2), h + ("vertical" === C ? h - k < m.point.y ? 0 : -k : (h - r / 2 < m.point.y ? k : 0) - r / 2)), d.stroke())
                }
            }
            ...
            for (a = 0; a < this._indexLabels.length; a++) m = this._indexLabels[a], g = la("indexLabelBackgroundColor", m.dataPoint, m.dataSeries), m.dataSeries.indexLabelBackgroundColor = s(g) ?
                w ? "transparent" : null : g;
            return d
        };
                ...
                for (var f = [], p, t = 0; t < a.dataSeriesIndexes.length; t++) {
                    ...
                    if (0 < m.length) {
                        for (var C = !1, u = 0; u < m.length; u++)
                            if (x = m[u].x.getTime ? m[u].x.getTime() : m[u].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax &&
                                    (!k.connectNullData || !C)))
                                if ("number" !== typeof m[u].y) 0 < u && !(k.connectNullData || C || l) && (c.stroke(), w && b.stroke()), C = !0;
                                else {
                                    ...
                                    l || C ? (!l && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || n === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(p.x,
                                        p.y), n = k.nullDataLineDashType, c.setLineDash(q)), c.lineTo(x, s), w && b.lineTo(x, s)) : (c.beginPath(), c.moveTo(x, s), w && (b.beginPath(), b.moveTo(x, s))), C = l = !1) : (c.lineTo(x, s), w && b.lineTo(x, s), 0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(x, s), w && (b.stroke(), b.beginPath(), b.moveTo(x, s))));
                                    p = { x: x, y: s };
                                    u < m.length - 1 && (g !== (m[u].lineColor || r) || n !== (m[u].lineDashType || k.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(x, s), g = m[u].lineColor || r, c.strokeStyle = g, c.setLineDash && (m[u].lineDashType ? (n = m[u].lineDashType,
                                        c.setLineDash(N(n, k.lineThickness))) : (n = k.lineDashType, c.setLineDash(h))));
                                    ...
                                    }(m[u].indexLabel || k.indexLabel || m[u].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({ chartType: "line", dataPoint: m[u], dataSeries: k, point: { x: x, y: s }, direction: 0 > m[u].y === a.axisY.reversed ? 1 : -1, color: r })
                                }
                        c.stroke();
                        w && b.stroke()
                    }
        ...
        l.prototype.renderStepLine = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var f = [], p, t = 0; t < a.dataSeriesIndexes.length; t++) {
                    ...
                    if (0 < m.length) {
                        for (var C = !1, u = 0; u < m.length; u++)
                            if (x = m[u].getTime ? m[u].x.getTime() :
                                m[u].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !C)))
                                if ("number" !== typeof m[u].y) 0 < u && !(k.connectNullData || C || l) && (c.stroke(), w && b.stroke()), C = !0;
                                else {
                                    var D = s;
                                    x = a.axisX.convertValueToPixel(x);
                                    ...
                                    l || C ? (!l && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || n === k.lineDashType &&
                                        k.lineDashType !== k.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(p.x, p.y), n = k.nullDataLineDashType, c.setLineDash(q)), c.lineTo(x, D), c.lineTo(x, s), w && (b.lineTo(x, D), b.lineTo(x, s))) : (c.beginPath(), c.moveTo(x, s), w && (b.beginPath(), b.moveTo(x, s))), C = l = !1) : (c.lineTo(x, D), w && b.lineTo(x, D), c.lineTo(x, s), w && b.lineTo(x, s), 0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(x, s), w && (b.stroke(), b.beginPath(), b.moveTo(x, s))));
                                    p = { x: x, y: s };
                                    u < m.length - 1 && (g !== (m[u].lineColor || r) || n !== (m[u].lineDashType || k.lineDashType)) &&
                                        (c.stroke(), c.beginPath(), c.moveTo(x, s), g = m[u].lineColor || r, c.strokeStyle = g, c.setLineDash && (m[u].lineDashType ? (n = m[u].lineDashType, c.setLineDash(N(n, k.lineThickness))) : (n = k.lineDashType, c.setLineDash(h))));
                                    if (0 < m[u].markerSize || 0 < k.markerSize) D = k.getMarkerProperties(u, x, s, c), f.push(D), z = P(z), w && f.push({ x: x, y: s, ctx: b, type: D.type, size: D.size, color: z, borderColor: z, borderThickness: D.borderThickness });
                    ...
                    if (0 < m.length)
                        for (x = !1, l = 0; l < m.length; l++)
                            if (u = m[l].getTime ? m[l].x.getTime() : m[l].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !x)))
                                if ("number" !== typeof m[l].y) 0 < l && !x && (k.connectNullData ? b.setLineDash && (0 <
                                    s.length && (k.options.nullDataLineDashType || !m[l - 1].lineDashType)) && (s[s.length - 1].newLineDashArray = q, n = k.nullDataLineDashType) : (d(s), s = [])), x = !0;
                                else {
                                    ...
                                    s[s.length] = { x: u, y: x };
                                    l < m.length - 1 && (g !== (m[l].lineColor || r) || n !== (m[l].lineDashType || k.lineDashType)) && (g = m[l].lineColor || r, s[s.length - 1].newStrokeStyle =
                                        g, b.setLineDash && (m[l].lineDashType ? (n = m[l].lineDashType, s[s.length - 1].newLineDashArray = N(n, k.lineThickness)) : (n = k.lineDashType, s[s.length - 1].newLineDashArray = h)));
                                    if (0 < m[l].markerSize || 0 < k.markerSize) {
                                        var D = k.getMarkerProperties(l, u, x, b);
                                        p.push(D);
                                        C = P(C);
        ...
        l.prototype.renderColumn = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null,
                    e = this.plotArea,
                    f = 0,
                    p, t, B, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                ...
                this.dataPointMaxWidth &&
                    f > m && (f = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, m));
                    ...
                    if (0 < r.length)
                        for (var g = 5 < n && h.bevelEnabled ? !0 : !1, f = 0; f < r.length; f++)
                            if (r[f].getTime ? B = r[f].x.getTime() : B = r[f].x, !(B < a.axisX.dataInfo.viewPortMin || B > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[f].y) {
                                ...
                                0 <= r[f].y ? u = k : (u = t, t = k);
                                t > u && (b = t, t = u, u = b);
                                b = r[f].color ? r[f].color : h._colorSet[f % h._colorSet.length];
                                ca(c, p, t, l, u, b, 0, null, g && 0 <= r[f].y, 0 > r[f].y && g, !1, !1, h.fillOpacity);
                                b = h.dataPointIds[f];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: f, x1: p, y1: t, x2: l, y2: u };
                                b = P(b);
                                w && ca(this._eventManager.ghostCtx, p, t, l, u, b, 0, null, !1, !1, !1, !1);
                                (r[f].indexLabel || h.indexLabel || r[f].indexLabelFormatter || h.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "column",
                                    dataPoint: r[f],
                                    dataSeries: h,
        ...
        l.prototype.renderStackedColumn = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null,
                    ...
                    B = [],
                    k = 0,
                    m, n, q = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                ...
                h = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * (e.width * (a.axisX.logarithmic ? Math.log(h) /
                    Math.log(a.axisX.range) : Math.abs(h) / Math.abs(a.axisX.range)) / a.plotType.plotUnits.length) << 0;
                        ...
                        for (k = 0; k < u.length; k++)
                            if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                                ...
                                if (a.axisY.logarithmic ||
                                    a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) t[b] = u[k].y + (t[b] ? t[b] : 0), 0 < t[b] && (n = a.axisY.convertValueToPixel(t[b]), D = "undefined" !== typeof f[b] ? f[b] : q, f[b] = n);
                                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) B[b] = u[k].y + (B[b] ? B[b] : 0), D = a.axisY.convertValueToPixel(B[b]), n = "undefined" !== typeof p[b] ? p[b] : q, p[b] = D;
                                    ...
                                    p[b] ? p[b] : 0, D = n + z, n = q + z, p[b] = z + (D - n);
                                b = u[k].color ? u[k].color : l._colorSet[k % l._colorSet.length];
                                ca(c, s, n, C, D, b, 0, null, x && 0 <= u[k].y, 0 > u[k].y && x, !1, !1, l.fillOpacity);
                                b = l.dataPointIds[k];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: g, dataPointIndex: k, x1: s, y1: n, x2: C, y2: D };
                                b = P(b);
                                w && ca(this._eventManager.ghostCtx, s, n, C, D, b, 0, null, !1, !1, !1, !1);
                                (u[k].indexLabel || l.indexLabel || u[k].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({
                ...
                for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                    ...
                    if (0 < u.length)
                        for (var x = 5 < h && l.bevelEnabled ? !0 : !1, k = 0; k < u.length; k++)
                            if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                                m = a.axisX.convertValueToPixel(b);
                                n = 0 !== a.dataPointYSums[b] ? 100 * (u[k].y / a.dataPointYSums[b]) : 0;
                                var s = m - a.plotType.plotUnits.length * h /
                                    2 + a.index * h << 0,
                                    C = s + h << 0,
                                    D;
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) {
                                    ...
                                    D = f[b] ? f[b] : q;
                                    f[b] = n
                                } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) B[b] = n + ("undefined" !== typeof B[b] ? B[b] : 0), D = a.axisY.convertValueToPixel(B[b]), n = p[b] ? p[b] : q, p[b] = D;
                                else if (n = a.axisY.convertValueToPixel(n), 0 <= u[k].y) {
                                    var z = "undefined" !== typeof f[b] ?
                                        f[b] : 0;
                                    n -= z;
                                    D = q - z;
                                    a.dataSeriesIndexes.length - 1 === r && 1 >= Math.abs(e.y1 - n) && (n = e.y1);
                                    f[b] = z + (D - n)
                                } else z = "undefined" !== typeof p[b] ? p[b] : 0, D = n + z, n = q + z, a.dataSeriesIndexes.length - 1 === r && 1 >= Math.abs(e.y2 - D) && (D = e.y2), p[b] = z + (D - n);
                                b = u[k].color ? u[k].color : l._colorSet[k % l._colorSet.length];
                                ca(c, s, n, C, D, b, 0, null, x && 0 <= u[k].y, 0 > u[k].y && x, !1, !1, l.fillOpacity);
                                b = l.dataPointIds[k];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: g, dataPointIndex: k, x1: s, y1: n, x2: C, y2: D };
                                b = P(b);
                                w && ca(this._eventManager.ghostCtx,
                                    s, n, C, D, b, 0, null, !1, !1, !1, !1);
                                (u[k].indexLabel || l.indexLabel || u[k].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedColumn100", dataPoint: u[k], dataSeries: l, point: { x: m, y: 0 <= u[k].y ? n : D }, direction: 0 > u[k].y === a.axisY.reversed ? 1 : -1, bounds: { x1: s, y1: Math.min(n, D), x2: C, y2: Math.max(n, D) }, color: b })
                            }
                }
            ...
            function(a) {
                ...
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    var b = null,
                        ...
                        m = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / a.plotType.totalDataSeries)) <<
                        0,
                        n = a.axisX.dataInfo.minDiff;
                    isFinite(n) || (n = 0.3 * Math.abs(a.axisX.range));
                    ...
                    for (m = 0; m < a.dataSeriesIndexes.length; m++) {
                        ...
                        if (0 < r.length) {
                            ...
                            for (f = 0; f < r.length; f++)
                                if (r[f].getTime ? B = r[f].x.getTime() : B = r[f].x, !(B <
                                        a.axisX.dataInfo.viewPortMin || B > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[f].y) {
                                    ...
                                    0 <= r[f].y ? u = k : (u = p, p = k);
                                    b = r[f].color ? r[f].color : h._colorSet[f % h._colorSet.length];
                                    ca(c, u, t, p, l, b, 0, null, g, !1, !1, !1, h.fillOpacity);
                                    b = h.dataPointIds[f];
                                    this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: f, x1: u, y1: t, x2: p, y2: l };
                                    b = P(b);
                                    w && ca(this._eventManager.ghostCtx, u, t, p, l, b, 0, null, !1, !1, !1, !1);
                                    (r[f].indexLabel || h.indexLabel || r[f].indexLabelFormatter || h.indexLabelFormatter) && this._indexLabels.push({ chartType: "bar", dataPoint: r[f], dataSeries: h, point: { x: 0 <= r[f].y ? p : u, y: t + (l - t) / 2 }, direction: 0 > r[f].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(u, p), y1: t, x2: Math.max(u, p), y2: l }, color: b })
                                }
                        }
                    }
                    w && (d.drawImage(this._preRenderCanvas,
                        ...
                        for (k = 0; k < u.length; k++)
                            if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                                ...
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) t[b] = u[k].y + (t[b] ? t[b] : 0), 0 < t[b] && (D = f[b] ? f[b] : q, f[b] = m = a.axisY.convertValueToPixel(t[b]));
                                    ...
                                    0 >= u[k].y) B[b] = u[k].y + (B[b] ? B[b] : 0), m = p[b] ? p[b] : q, p[b] = D = a.axisY.convertValueToPixel(B[b]);
                                else if (m = a.axisY.convertValueToPixel(u[k].y), 0 <= u[k].y) {
                                    var z = f[b] ? f[b] : 0;
                                    D = q + z;
                                    m += z;
                                    f[b] = z + (m - D)
                                } else z = p[b] ? p[b] : 0, D = m - z, m = q - z, p[b] = z + (m - D);
                                b = u[k].color ? u[k].color : l._colorSet[k % l._colorSet.length];
                                ca(c, D, s, m, C, b, 0, null, x, !1, !1, !1, l.fillOpacity);
                                b = l.dataPointIds[k];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: g, dataPointIndex: k, x1: D, y1: s, x2: m, y2: C };
                                b = P(b);
                                w && ca(this._eventManager.ghostCtx,
                                    D, s, m, C, b, 0, null, !1, !1, !1, !1);
                                (u[k].indexLabel || l.indexLabel || u[k].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedBar", dataPoint: u[k], dataSeries: l, point: { x: 0 <= u[k].y ? m : D, y: n }, direction: 0 > u[k].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(D, m), y1: s, x2: Math.max(D, m), y2: C }, color: b })
                            }
                    }
                }
                        ...
                        if (0 < u.length) {
                            ...
                            for (k = 0; k < u.length; k++)
                                if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin ||
                                    ...
                                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) {
                                    ...
                                    } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) B[b] =
                                        A + (B[b] ? B[b] : 0), m = p[b] ? p[b] : q, p[b] = A = a.axisY.convertValueToPixel(B[b]);
                                        ...
                                        f[b] = z + (m - A)
                                    } else z = p[b] ? p[b] : 0, A = m - z, m = q - z, a.dataSeriesIndexes.length - 1 === r && 1 >= Math.abs(e.x1 - A) && (A = e.x1), p[b] = z + (m - A);
                                    b = u[k].color ? u[k].color : l._colorSet[k % l._colorSet.length];
                                    ca(c, A, C, m, D, b, 0, null, s, !1, !1, !1, l.fillOpacity);
                                    b = l.dataPointIds[k];
                                    ...
                                    b = P(b);
                                    w && ca(this._eventManager.ghostCtx, A, C, m, D, b, 0, null, !1, !1, !1, !1);
                                    (u[k].indexLabel || l.indexLabel || u[k].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedBar100", dataPoint: u[k], dataSeries: l, point: { x: 0 <= u[k].y ? m : A, y: n }, direction: 0 > u[k].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(A, m), y1: C, x2: Math.max(A, m), y2: D }, color: b })
                                }
                        }
                    }
        ...
        l.prototype.renderArea = function(a) {
            ...
            function b() {
                D && (0 < h.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? C = A : 0 > a.axisY.viewportMaximum ? C = t.y1 : 0 < a.axisY.viewportMinimum && (C = A), f.lineTo(l, C), f.lineTo(D.x, C), f.closePath(), f.globalAlpha = h.fillOpacity, f.fill(), f.globalAlpha = 1, w && (p.lineTo(l, C), p.lineTo(D.x, C), p.closePath(), p.fill()), f.beginPath(), f.moveTo(l,
                    u), p.beginPath(), p.moveTo(l, u), D = { x: l, y: u })
            }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    d = !0;
                    var g = 0,
                        l, u, s, A = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                        C, D = null;
                    if (0 < r.length) {
                        ...
                        for (var ja = !0; g < r.length; g++)
                            if (s =
                                r[g].x.getTime ? r[g].x.getTime() : r[g].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !ja)))
                                if ("number" !== typeof r[g].y) h.connectNullData || (ja || d) || b(), ja = !0;
                                else {
                                    l = a.axisX.convertValueToPixel(s);
                                    u = a.axisY.convertValueToPixel(r[g].y);
                                    d || ja ? (!d && h.connectNullData ? (f.setLineDash && (h.options.nullDataLineDashType || c === h.lineDashType && h.lineDashType !== h.nullDataLineDashType) && (d = l, c = u, l = m.x, u = m.y, b(), f.moveTo(m.x, m.y), l = d, u = c, D = m, c = h.nullDataLineDashType, f.setLineDash(Q)),
                                        f.lineTo(l, u), w && p.lineTo(l, u)) : (f.beginPath(), f.moveTo(l, u), w && (p.beginPath(), p.moveTo(l, u)), D = { x: l, y: u }), ja = d = !1) : (f.lineTo(l, u), w && p.lineTo(l, u), 0 == g % 250 && b());
                                    m = { x: l, y: u };
                                    g < r.length - 1 && (y !== (r[g].lineColor || v) || c !== (r[g].lineDashType || h.lineDashType)) && (b(), y = r[g].lineColor || v, f.strokeStyle = y, f.setLineDash && (r[g].lineDashType ? (c = r[g].lineDashType, f.setLineDash(N(c, h.lineThickness))) : (c = h.lineDashType, f.setLineDash(aa))));
                                    ...
                                    0 !== r[g].markerSize && (0 < r[g].markerSize || 0 < h.markerSize) && (s = h.getMarkerProperties(g, l, u, f), B.push(s), Y = P(Y), w && B.push({ x: l, y: u, ctx: p, type: s.type, size: s.size, color: Y, borderColor: Y, borderThickness: s.borderThickness }));
                                    (r[g].indexLabel || h.indexLabel || r[g].indexLabelFormatter || h.indexLabelFormatter) && this._indexLabels.push({ chartType: "area", dataPoint: r[g], dataSeries: h, point: { x: l, y: u }, direction: 0 > r[g].y === a.axisY.reversed ? 1 : -1, color: z })
                                }
                        b();
                        V.drawMarkers(B)
                    }
        ...
        l.prototype.renderSplineArea = function(a) {
            function d() {
                ...
                if (0 < c.length) {
                    ...
                    a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum &&
                        0 <= a.axisY.viewportMaximum ? l = g : 0 > a.axisY.viewportMaximum ? l = f.y1 : 0 < a.axisY.viewportMinimum && (l = g);
                    u = { x: c[0].x, y: c[0].y };
                    ...
                    b.fill();
                    b.globalAlpha = 1;
                    w && (e.lineTo(c[c.length - 1].x, l), e.lineTo(u.x, l), e.closePath(), e.fill())
                }
            }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var B = 0; B < a.dataSeriesIndexes.length; B++) {
                    ...
                    var p = [],
                        q = 0,
                        h, r, g = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                        l, u = null,
                        s = [];
                    if (0 < n.length) {
                        ...
                        for (r = !1; q < n.length; q++)
                            if (h = n[q].x.getTime ? n[q].x.getTime() : n[q].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !r)))
                                if ("number" !== typeof n[q].y) 0 < q && !r && (m.connectNullData ? b.setLineDash && (0 < s.length && (m.options.nullDataLineDashType ||
                                    !n[q - 1].lineDashType)) && (s[s.length - 1].newLineDashArray = y, z = m.nullDataLineDashType) : (d(), s = [])), r = !0;
                                else {
                                    ...
                                    s[s.length] = { x: h, y: r };
                                    q < n.length - 1 && (D !== (n[q].lineColor || C) || z !== (n[q].lineDashType || m.lineDashType)) && (D = n[q].lineColor || C, s[s.length - 1].newStrokeStyle = D, b.setLineDash && (n[q].lineDashType ? (z =
                                        n[q].lineDashType, s[s.length - 1].newLineDashArray = N(z, m.lineThickness)) : (z = m.lineDashType, s[s.length - 1].newLineDashArray = E)));
                                    if (0 !== n[q].markerSize && (0 < n[q].markerSize || 0 < m.markerSize)) {
                                        var aa = m.getMarkerProperties(q, h, r, b);
                                        p.push(aa);
                                        Q = P(Q);
        ...
        l.prototype.renderStepArea = function(a) {
            ...
            function b() {
                D && (0 < h.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? C = A : 0 > a.axisY.viewportMaximum ? C = t.y1 : 0 < a.axisY.viewportMinimum && (C = A), f.lineTo(l, C), f.lineTo(D.x, C), f.closePath(), f.globalAlpha = h.fillOpacity, f.fill(), f.globalAlpha =
                    1, w && (p.lineTo(l, C), p.lineTo(D.x, C), p.closePath(), p.fill()), f.beginPath(), f.moveTo(l, u), p.beginPath(), p.moveTo(l, u), D = { x: l, y: u })
            }
            var e = a.targetCanvasCtx || this.plotArea.ctx,
                f = w ? this._preRenderCtx : e;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    if (0 < r.length) {
                        ...
                        for (; g < r.length; g++)
                            if (s = r[g].x.getTime ? r[g].x.getTime() : r[g].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !c))) {
                                var Y = u;
                                "number" !== typeof r[g].y ? (h.connectNullData || (c || d) || b(), c = !0) : (l = a.axisX.convertValueToPixel(s), u = a.axisY.convertValueToPixel(r[g].y), d || c ? (!d && h.connectNullData ? (f.setLineDash && (h.options.nullDataLineDashType || Q === h.lineDashType && h.lineDashType !== h.nullDataLineDashType) && (d = l,
        ...
        l.prototype.renderStackedArea = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null,
                    ...
                    n = [],
                    q = 0,
                    h, r, l = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                        ...
                        for (var Y = !0, q = 0; q < m.length; q++) {
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !Y)))
                                if ("number" !== typeof fa.y) z.connectNullData || (Y || x) || d(), Y = !0;
                                    ...
                                    k.push({ x: h, y: l - ma });
                                    g[f] = l - r;
                                    x || Y ? (!x && z.connectNullData ? (b.setLineDash && (z.options.nullDataLineDashType || A === z.lineDashType && z.lineDashType !== z.nullDataLineDashType) && (x = k.pop(), A = k[k.length - 1], d(), b.moveTo(u.x, u.y), k.push(A), k.push(x), A = z.nullDataLineDashType,
                                        b.setLineDash(aa)), b.lineTo(h, r), w && s.lineTo(h, r)) : (b.beginPath(), b.moveTo(h, r), w && (s.beginPath(), s.moveTo(h, r))), Y = x = !1) : (b.lineTo(h, r), w && s.lineTo(h, r), 0 == q % 250 && (d(), b.moveTo(h, r), w && s.moveTo(h, r), k.push({ x: h, y: l - ma })));
                                    u = { x: h, y: r };
                                    q < v.length - 1 && (Q !== (v[q].lineColor || y) || A !== (v[q].lineDashType || z.lineDashType)) && (d(), b.beginPath(), b.moveTo(h, r), k.push({ x: h, y: l - ma }), Q = v[q].lineColor || y, b.strokeStyle = Q, b.setLineDash && (v[q].lineDashType ? (A = v[q].lineDashType, b.setLineDash(N(A, z.lineThickness))) : (A =
                                    ...
                                    0 <= z.dataPointIndexes[f] && 0 !== fa.markerSize && (0 < fa.markerSize || 0 < z.markerSize) && (ma = z.getMarkerProperties(z.dataPointIndexes[f], h, r, b), p.push(ma), f = P(F), w && p.push({ x: h, y: r, ctx: s, type: ma.type, size: ma.size, color: f, borderColor: f, borderThickness: ma.borderThickness }));
                                    (fa.indexLabel ||
                                        z.indexLabel || fa.indexLabelFormatter || z.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedArea", dataPoint: fa, dataSeries: z, point: { x: h, y: r }, direction: 0 > v[q].y === a.axisY.reversed ? 1 : -1, color: e })
                                }
                        }
                        d();
                        b.moveTo(h, r);
                ...
                w && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas,
                    0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(t.x1, t.y1, t.width, t.height), s.restore());
                b.restore();
                return { source: c, dest: this.plotArea.ctx, animationCallback: K.xClipAnimation, easingFunction: K.easing.linear, animationBase: 0 }
            }
        };
        l.prototype.renderStackedArea100 = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null,
                    ...
                    n = [],
                    q = 0,
                    h, r, l, s, u, x = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                ...
                b.clip();
                w && (A.beginPath(), A.rect(p.x1, p.y1, p.width,
                    p.height), A.clip());
                for (var e = [], C = 0; C < a.dataSeriesIndexes.length; C++) {
                ...
                for (C = 0; C < a.dataSeriesIndexes.length; C++) {
                    ...
                    if (0 < m.length) {
                        var e =
                            z._colorSet[q % z._colorSet.length],
                        ...
                        for (var Y = !0, q = 0; q < m.length; q++) {
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !Y)))
                                if ("number" !== typeof fa.y) z.connectNullData ||
                                    ...
                                    k.push({ x: h, y: x - ba });
                                    g[f] = x - r;
                                    s || Y ? (!s && z.connectNullData ? (b.setLineDash && (z.options.nullDataLineDashType || u === z.lineDashType &&
                                        z.lineDashType !== z.nullDataLineDashType) && (s = k.pop(), u = k[k.length - 1], d(), b.moveTo(l.x, l.y), k.push(u), k.push(s), u = z.nullDataLineDashType, b.setLineDash(aa)), b.lineTo(h, r), w && A.lineTo(h, r)) : (b.beginPath(), b.moveTo(h, r), w && (A.beginPath(), A.moveTo(h, r))), Y = s = !1) : (b.lineTo(h, r), w && A.lineTo(h, r), 0 == q % 250 && (d(), b.moveTo(h, r), w && A.moveTo(h, r), k.push({ x: h, y: x - ba })));
                                    l = { x: h, y: r };
                                    q < y.length - 1 && (Q !== (y[q].lineColor || E) || u !== (y[q].lineDashType || z.lineDashType)) && (d(), b.beginPath(), b.moveTo(h, r), k.push({
                                        x: h,
                                        y: x -
                                            ba
                                    }), Q = y[q].lineColor || E, b.strokeStyle = Q, b.setLineDash && (y[q].lineDashType ? (u = y[q].lineDashType, b.setLineDash(N(u, z.lineThickness))) : (u = z.lineDashType, b.setLineDash(F))));
                                    if (0 <= z.dataPointIndexes[f]) {
                                    ...
                                    0 <= z.dataPointIndexes[f] && 0 !== fa.markerSize && (0 < fa.markerSize || 0 < z.markerSize) && (ba = z.getMarkerProperties(q, h, r, b), t.push(ba), f = P(G),
                                        w && t.push({ x: h, y: r, ctx: A, type: ba.type, size: ba.size, color: f, borderColor: f, borderThickness: ba.borderThickness }));
                                    (fa.indexLabel || z.indexLabel || fa.indexLabelFormatter || z.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedArea100", dataPoint: fa, dataSeries: z, point: { x: h, y: r }, direction: 0 > y[q].y === a.axisY.reversed ? 1 : -1, color: e })
                                }
                        }
                        d();
                        b.moveTo(h, r);
        ...
        l.prototype.renderBubble = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var t = -Infinity, g = Infinity, k = 0; k < a.dataSeriesIndexes.length; k++)
                    for (var m = a.dataSeriesIndexes[k], n = this.data[m], q = n.dataPoints,
                            h = 0, e = 0; e < q.length; e++) f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof q[e].z || (h = q[e].z, h > t && (t = h), h < g && (g = h));
                    ...
                    if (m = a.dataSeriesIndexes[k], n = this.data[m], q = n.dataPoints, 0 < q.length)
                        for (c.strokeStyle = "#4572A7 ", e = 0; e < q.length; e++)
                            if (f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, !(f < a.axisX.dataInfo.viewPortMin ||
                                ...
                                V.drawMarker(f, p, c, h.type, h.size, h.color, h.borderColor, h.borderThickness);
                                c.globalAlpha = 1;
                                ...
                                (q[e].indexLabel || n.indexLabel || q[e].indexLabelFormatter || n.indexLabelFormatter) && this._indexLabels.push({ chartType: "bubble", dataPoint: q[e], dataSeries: n, point: { x: f, y: p }, direction: 1, bounds: { x1: f - h.size / 2, y1: p - h.size / 2, x2: f + h.size / 2, y2: p + h.size / 2 }, color: null })
                            }
                    ...
                    if (0 < m.length) {
                        ...
                        for (var n = 0, q = 0, e = 0; e < m.length; e++)
                            if (f = m[e].getTime ? f = m[e].x.getTime() : f = m[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[e].y) {
                                ...
                                c.globalAlpha = 1;
                                Math.sqrt((n - f) * (n - f) + (q - p) * (q - p)) < Math.min(h.size, 5) && m.length > Math.min(this.plotArea.width,
        ...
        l.prototype.renderCandlestick = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null,
                    ...
                    p = this.plotArea,
                    t = 0,
                    g, k, m, n, q, h, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1,
                ...
                for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if (0 < x.length)
                        for (var A = 5 < r && u.bevelEnabled ? !0 : !1, t = 0; t < x.length; t++)
                            if (x[t].getTime ? h = x[t].x.getTime() : h = x[t].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !s(x[t].y) && x[t].y.length && "number" === typeof x[t].y[0] &&
                                ...
                                "candlestick" === u.type ? (c.moveTo(g - y, m), c.lineTo(g - y, Math.min(k, q)), c.stroke(), c.moveTo(g - y, Math.max(k, q)), c.lineTo(g - y, n), c.stroke(), ca(c, C, Math.min(k, q), D, Math.max(k, q), x[t].y[0] <= x[t].y[3] ? u.risingColor : f, z, e, A, A, !1, !1, u.fillOpacity), w && (e = P(E), b.strokeStyle = e, b.moveTo(g - y, m), b.lineTo(g - y, Math.min(k,
                                    q)), b.stroke(), b.moveTo(g - y, Math.max(k, q)), b.lineTo(g - y, n), b.stroke(), ca(b, C, Math.min(k, q), D, Math.max(k, q), e, 0, null, !1, !1, !1, !1))) : "ohlc" === u.type && (c.moveTo(g - y, m), c.lineTo(g - y, n), c.stroke(), c.beginPath(), c.moveTo(g, k), c.lineTo(C, k), c.stroke(), c.beginPath(), c.moveTo(g, q), c.lineTo(D, q), c.stroke(), w && (e = P(E), b.strokeStyle = e, b.moveTo(g - y, m), b.lineTo(g - y, n), b.stroke(), b.beginPath(), b.moveTo(g, k), b.lineTo(C, k), b.stroke(), b.beginPath(), b.moveTo(g, q), b.lineTo(D, q), b.stroke()));
                                (x[t].indexLabel || u.indexLabel ||
                ...
                w && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height),
                    this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(p.x1, p.y1, p.width, p.height), b.restore());
                c.restore();
                return { source: d, dest: this.plotArea.ctx, animationCallback: K.fadeInAnimation, easingFunction: K.easing.easeInQuad, animationBase: 0 }
            }
        };
        l.prototype.renderBoxAndWhisker = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null,
                    f = this.plotArea,
                    p = 0,
                    t, g, k, m, n, q, h, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1,
                ...
                this.dataPointMaxWidth && e >
                    p && (e = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, p));
                ...
                for (var l = !1, l = !!a.axisY.reversed, v = 0; v < a.dataSeriesIndexes.length; v++) {
                    ...
                    if (0 < A.length)
                        for (var C = 5 < r && x.bevelEnabled ? !0 : !1, p = 0; p < A.length; p++)
                            if (A[p].getTime ? h = A[p].x.getTime() : h = A[p].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !s(A[p].y) && A[p].y.length && "number" === typeof A[p].y[0] && "number" === typeof A[p].y[1] && "number" === typeof A[p].y[2] && "number" === typeof A[p].y[3] && "number" === typeof A[p].y[4] && 5 === A[p].y.length) {
                                ...
                                var D = t - r / 2 << 0,
                                    ...
                                    J = A[p].stemDashType ? A[p].stemDashType :
                                    x.stemDashType,
                                ...
                                c.save();
                                0 < ba && (c.beginPath(), c.strokeStyle = ma, c.lineWidth = ba, c.setLineDash && c.setLineDash(N(J, ba)), c.moveTo(t - G, k), c.lineTo(t - G, g), c.stroke(), c.moveTo(t - G, n), c.lineTo(t - G, m), c.stroke());
                                c.restore();
                                b.lineWidth = Math.max(y, 4);
                                c.beginPath();
                                ca(c, D, Math.min(q, k), z, Math.max(k, q), xa, 0, e, l ? C : !1, l ? !1 : C, !1, !1, sa);
                                c.beginPath();
                                ca(c, D, Math.min(m, q), z, Math.max(q, m), R, 0, e, l ? !1 : C, l ? C : !1, !1, !1, sa);
                                c.beginPath();
                                c.lineWidth = y;
                                c.strokeStyle = e;
                                ...
                                c.restore();
                                c.save();
                                0 < aa && (c.beginPath(), c.setLineDash && c.setLineDash(N(F, aa)), c.strokeStyle = Q, c.lineWidth = aa, c.moveTo(t - Y / 2 << 0, n - fa), c.lineTo(t + Y / 2 << 0, n -
                                    fa), c.stroke(), c.moveTo(t - Y / 2 << 0, g + fa), c.lineTo(t + Y / 2 << 0, g + fa), c.stroke());
                                c.restore();
                                ...
                                (A[p].indexLabel || x.indexLabel || A[p].indexLabelFormatter ||
        ...
        l.prototype.renderRangeColumn = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null,
                    e = this.plotArea,
                    f = 0,
                    p, t, g, f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth :
                    1;
                ...
                !this.dataPointMaxWidth &&
                    (this.dataPointMinWidth && p < f) && (p = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, f));
                k < f && (k = f);
                k > p && (k = p);
                c.save();
                w && this._eventManager.ghostCtx.save();
                ...
                for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                    ...
                    if (0 < h.length)
                        for (var r =
                                5 < k && q.bevelEnabled ? !0 : !1, f = 0; f < h.length; f++)
                            if (h[f].getTime ? g = h[f].x.getTime() : g = h[f].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(h[f].y) && h[f].y.length && "number" === typeof h[f].y[0] && "number" === typeof h[f].y[1]) {
                                b = a.axisX.convertValueToPixel(g);
                                p = a.axisY.convertValueToPixel(h[f].y[0]);
                                t = a.axisY.convertValueToPixel(h[f].y[1]);
                                var l = a.axisX.reversed ? b + a.plotType.totalDataSeries * k / 2 - (a.previousDataSeriesCount + m) * k << 0 : b - a.plotType.totalDataSeries * k / 2 + (a.previousDataSeriesCount +
                                        m) * k << 0,
                                    v = a.axisX.reversed ? l - k << 0 : l + k << 0,
                                    b = h[f].color ? h[f].color : q._colorSet[f % q._colorSet.length];
                                if (p > t) {
                                    var u = p;
                                    p = t;
                                    t = u
                                ...
                                ca(c, l, p, v, t, b, 0, b, r, r, !1, !1, q.fillOpacity);
                                b = P(u);
                                w && ca(this._eventManager.ghostCtx, l, p, v, t, b, 0, null, !1, !1, !1, !1);
                                if (h[f].indexLabel || q.indexLabel || h[f].indexLabelFormatter || q.indexLabelFormatter) this._indexLabels.push({
            ...
            function(a) {
                ...
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    var e = null,
                        ...
                        p = this.plotArea,
                        t = 0,
                        g, k, m, n, q, h, r, l = a.axisX.dataInfo.minDiff;
                    ...
                    c.rect(p.x1, p.y1, p.width, p.height);
                    c.clip();
                    w && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(p.x1,
                        p.y1, p.width, p.height), this._eventManager.ghostCtx.clip());
                    ...
                    for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
                        var A = a.dataSeriesIndexes[x],
                            C = this.data[A],
                            D = C.dataPoints,
                            z = s(C._linkedSeries) ? !1 : C._linkedSeries.type.match(/(bar|column)/ig) && C._linkedSeries.visible ? !0 : !1,
                            E = 0;
                        if (z)
                        ...
                        u = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * ((b ? p.height : p.width) * (a.axisX.logarithmic ? Math.log(l) / Math.log(a.axisX.range) : Math.abs(l) / Math.abs(a.axisX.range)) / (z ? v : 1)) << 0;
                            ...
                            for (var F = C._colorSet, t = 0; t < D.length; t++) {
                                ...
                                if (!(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax) && !s(D[t].y) && D[t].y.length && "number" === typeof D[t].y[0] && "number" === typeof D[t].y[1]) {
                                    ...
                                    b ? (q = a.axisX.reversed ? k + (z ?
                                        v : 1) * u / 2 - (z ? E - 1 : 0) * u << 0 : k - (z ? v : 1) * u / 2 + (z ? E - 1 : 0) * u << 0, h = a.axisX.reversed ? q - u << 0 : q + u << 0) : (m = a.axisX.reversed ? g + (z ? v : 1) * u / 2 - (z ? E - 1 : 0) * u << 0 : g - (z ? v : 1) * u / 2 + (z ? E - 1 : 0) * u << 0, n = a.axisX.reversed ? m - u << 0 : m + u << 0);
                                    !b && q > h && (ja = q, q = h, h = ja);
                                    b && m > n && (ja = m, m = n, n = ja);
                                    ja = C.dataPointIds[t];
                                    this._eventManager.objectMap[ja] = { id: ja, objectType: "dataPoint", dataSeriesIndex: A, dataPointIndex: t, x1: Math.min(m, n), y1: Math.min(q, h), x2: Math.max(n, m), y2: Math.max(h, q), isXYSwapped: b, stemProperties: aa, whiskerProperties: Q };
                                    y(c, Math.min(m,
                                        n), Math.min(q, h), Math.max(n, m), Math.max(h, q), e, Q, aa, b);
                                    w && y(this._eventManager.ghostCtx, m, q, n, h, e, Q, aa, b);
                    ...
                    w && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height),
                        a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(p.x1, p.y1, p.width, p.height), this._eventManager.ghostCtx.restore());
                    c.restore();
                    return { source: d, dest: this.plotArea.ctx, animationCallback: K.fadeInAnimation, easingFunction: K.easing.easeInQuad, animationBase: 0 }
                }
            };
        l.prototype.renderRangeBar = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null,
                    e = this.plotArea,
                    f = 0,
                    p, t, g, k, f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                    ...
                    if (0 < r.length) {
                        ...
                        for (f = 0; f < r.length; f++)
                            if (r[f].getTime ? k = r[f].x.getTime() : k = r[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !s(r[f].y) && r[f].y.length && "number" === typeof r[f].y[0] && "number" === typeof r[f].y[1]) {
                                ...
                                p > t && (b = p, p = t, t = b);
                                b = r[f].color ? r[f].color : h._colorSet[f % h._colorSet.length];
                                ca(c, p, g, t, v, b, 0, null, l, !1, !1, !1, h.fillOpacity);
                                b = h.dataPointIds[f];
                                this._eventManager.objectMap[b] = {
                                    id: b,
                                    objectType: "dataPoint",
        ...
        l.prototype.renderRangeArea = function(a) {
            function d() {
                if (x) {
                    for (var a = null, c = g.length - 1; 0 <= c; c--) a = g[c], b.lineTo(a.x, a.y2), e.lineTo(a.x, a.y2);
                    b.closePath();
                    b.globalAlpha = m.fillOpacity;
                    b.fill();
                    b.globalAlpha = 1;
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                            ...
                            if (u = n[h].x.getTime ? n[h].x.getTime() : n[h].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !Q)))
                                if (null !== n[h].y && n[h].y.length && "number" === typeof n[h].y[0] && "number" === typeof n[h].y[1]) {
                                    ...
                                    if (0 !== n[h].markerSize && (0 < n[h].markerSize || 0 < m.markerSize)) {
                                        ...
                                        aa = m.getMarkerProperties(h, r, l, b);
                                        f.push(aa);
                                        F = P(u);
                ...
                w && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
                    0, 0, this.width, this.height), b.clearRect(p.x1, p.y1, p.width, p.height), this._eventManager.ghostCtx.restore());
                b.restore();
                return { source: c, dest: this.plotArea.ctx, animationCallback: K.xClipAnimation, easingFunction: K.easing.linear, animationBase: 0 }
            }
        };
                    ...
                    if (0 < k.lineThickness) {
                        ...
                        for (var h = f = 0; f < d.length - 3; f += 3, h++) {
                            if (l[h].newStrokeStyle || l[h].newLineDashArray) b.stroke(), b.beginPath(),
                                b.moveTo(d[f].x, d[f].y), l[h].newStrokeStyle && (b.strokeStyle = l[h].newStrokeStyle), l[h].newLineDashArray && b.setLineDash(l[h].newLineDashArray);
                            b.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y)
                        }
                        d = v(l, 2);
                        b.moveTo(d[0].x, d[0].y);
                        for (h = f = 0; f < d.length - 3; f += 3, h++) {
                            if (l[h].newStrokeStyle || l[h].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(d[f].x, d[f].y), l[h].newStrokeStyle && (b.strokeStyle = l[h].newStrokeStyle), l[h].newLineDashArray && b.setLineDash(l[h].newLineDashArray);
                            b.bezierCurveTo(d[f +
                ...
                for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
                    ...
                    if (0 < m.length) {
                        ...
                        for (h = !1; n < m.length; n++)
                            if (q = m[n].x.getTime ? m[n].x.getTime() : m[n].x, !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!k.connectNullData ||
                                    !h)))
                                if (null !== m[n].y && m[n].y.length && "number" === typeof m[n].y[0] && "number" === typeof m[n].y[1]) {
                                    ...
                                    l[l.length] = { x: q, y: h };
                                    s[s.length] = { x: q, y: r };
                                    n < m.length - 1 && (A !== (m[n].lineColor || x) || C !== (m[n].lineDashType || k.lineDashType)) && (A = m[n].lineColor || x, l[l.length -
                                        1].newStrokeStyle = A, b.setLineDash && (m[n].lineDashType ? (C = m[n].lineDashType, l[l.length - 1].newLineDashArray = N(C, k.lineThickness)) : (C = k.lineDashType, l[l.length - 1].newLineDashArray = D)));
                                    ...
                                    if (m[n].indexLabel || k.indexLabel || m[n].indexLabelFormatter || k.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: m[n], dataSeries: k, indexKeyword: 0, point: { x: q, y: h }, direction: m[n].y[0] <= m[n].y[1] ? -1 : 1, color: u }), this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: m[n], dataSeries: k, indexKeyword: 1, point: { x: q, y: r }, direction: m[n].y[0] <= m[n].y[1] ? 1 : -1, color: u });
                                    h = !1
                                } else 0 < n && !h && (k.connectNullData ? b.setLineDash &&
                                    (0 < l.length && (k.options.nullDataLineDashType || !m[n - 1].lineDashType)) && (l[l.length - 1].newLineDashArray = z, C = k.nullDataLineDashType) : (d(D, x), l = [], s = [])), h = !0;
                        d(D, x);
                        V.drawMarkers(f)
                    }
                }
        ...
        l.prototype.renderWaterfall = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = this._eventManager.ghostCtx,
                    ...
                    f = this.plotArea,
                    p = 0,
                    t, g, k, m, n = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
                ...
                for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                    ...
                    if (0 < v.length)
                        for (var A = 5 < q && s.bevelEnabled ? !0 : !1, C = !1, D = null, z = null, p = 0; p < v.length; p++)
                            if (v[p].getTime ?
                                m = v[p].x.getTime() : m = v[p].x, "number" !== typeof v[p].y) {
                                ...
                                t = a.axisX.reversed ? t + a.plotType.totalDataSeries *
                                    q / 2 - (a.previousDataSeriesCount + h) * q << 0 : t - a.plotType.totalDataSeries * q / 2 + (a.previousDataSeriesCount + h) * q << 0;
                                ...
                                var aa, Q = t;
                                aa = "undefined" !== typeof v[p].isIntermediateSum && !0 === v[p].isIntermediateSum || "undefined" !== typeof v[p].isCumulativeSum && !0 === v[p].isCumulativeSum ? 0 < v[p].y ? g : k : 0 < v[p].y ? k : g;
                                0 < p && D && (!C || s.connectNullData) && (C && c.setLineDash && c.setLineDash(N(y, u)), c.beginPath(), c.moveTo(D, z - x), c.lineTo(Q, aa - x), 0 < u && c.stroke(), w && (b.beginPath(), b.moveTo(D, z - x), b.lineTo(Q, aa - x), 0 < u && b.stroke()));
                                C = !1;
                                D = E;
                                z = 0 < v[p].y ? g : k;
                                Q = v[p].lineDashType ? v[p].lineDashType : s.options.lineDashType ? s.options.lineDashType :
                                    "shortDash";
                                ...
                                (v[p].indexLabel || s.indexLabel || v[p].indexLabelFormatter || s.indexLabelFormatter) && this._indexLabels.push({ chartType: "waterfall", dataPoint: v[p], dataSeries: s, point: { x: t + (E - t) / 2, y: 0 <= v[p].y ? g : k }, direction: 0 > v[p].y === a.axisY.reversed ? 1 : -1, bounds: { x1: t, y1: Math.min(g, k), x2: E, y2: Math.max(g, k) }, color: e })
                            }
                }
        ...
        var ga = function(a, d, c, b, e, f, p, g, l) {
            if (!(0 > c)) {
                ...
                a.save();
                a.globalAlpha = g;
                "pie" === e ? (a.beginPath(), a.moveTo(d.x, d.y), a.arc(d.x, d.y, c, f, p, !1), a.fillStyle = b, a.strokeStyle = "white", a.lineWidth = 2, a.closePath(), a.fill()) : "doughnut" === e && (a.beginPath(), a.arc(d.x, d.y, c, f, p, !1), 0 <= l && a.arc(d.x, d.y, l * c, p, f, !0), a.closePath(), a.fillStyle = b, a.strokeStyle = "white", a.lineWidth =
                    2, a.fill());
                a.globalAlpha = 1;
                a.restore()
            }
        ...
        l.prototype.renderPie = function(a) {
            function d() {
                if (k && m) {
                    for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < m.length; e++) {
                        ...
                        n = f.indexLabelFormatter ? f.indexLabelFormatter(t) :
                            f.indexLabel ? l.replaceKeywordsWithValue(f.indexLabel, f, k, e) : k.indexLabelFormatter ? k.indexLabelFormatter(t) : k.indexLabel ? l.replaceKeywordsWithValue(k.indexLabel, f, k, e) : f.label ? f.label : "";
                        ...
                        g.indexLabelLineColor = f.indexLabelLineColor ? f.indexLabelLineColor : k.options.indexLabelLineColor ? k.options.indexLabelLineColor : f.color ? f.color : k._colorSet[e %
                            k._colorSet.length];
                        ...
                        g.indexLabelWrap = "undefined" !== typeof f.indexLabelWrap ?
                        ...
                        if (g.midAngle > Math.PI / 2 - u && g.midAngle < Math.PI / 2 + u) {
                            ...
                            3 * Math.PI / 2 - u && g.midAngle < 3 * Math.PI / 2 + u) {
                    ...
                    p = f = 0;
                    n = !1;
                    for (e = 0; e < m.length; e++) g = h[(c + e) % m.length], 1 < a && (g.midAngle > Math.PI / 2 - u && g.midAngle < Math.PI / 2 + u) && (f <= a / 2 && !n ? (g.hemisphere = "right", f++) : (g.hemisphere = "left", n = !0));
                    n = !1;
                    for (e = 0; e < m.length; e++) g = h[(d + e) % m.length], 1 < b && (g.midAngle > 3 * Math.PI / 2 - u && g.midAngle < 3 * Math.PI / 2 + u) && (p <= b / 2 && !n ? (g.hemisphere = "left", p++) : (g.hemisphere = "right", n = !0))
                }
            }
            ...
            function c(a) {
                ...
                for (b = 0; b < m.length; b++) {
                    ...
                    if (d > c) {
                        var e = 0.07 * z * Math.cos(h[b].midAngle),
                            ...
                            p = !1;
                        if (m[b].exploded) { if (1E-9 < Math.abs(h[b].center.x - (A.x + e)) || 1E-9 < Math.abs(h[b].center.y - (A.y + f))) h[b].center.x = A.x + e * a, h[b].center.y = A.y + f * a, p = !0 } else if (0 < Math.abs(h[b].center.x - A.x) || 0 < Math.abs(h[b].center.y - A.y)) h[b].center.x = A.x + e * (1 - a), h[b].center.y = A.y + f * (1 - a),
                            p = !0;
                        p && (e = {}, e.dataSeries = k, e.dataPoint = k.dataPoints[b], e.index = b, l.toolTip.highlightObjects([e]));
                        ga(l.plotArea.ctx, h[b].center, h[b].radius, m[b].color ? m[b].color : k._colorSet[b % k._colorSet.length], k.type, c, d, k.fillOpacity, h[b].percentInnerRadius)
                    }
                }
                a = l.plotArea.ctx;
                a.save();
                ...
                a.lineJoin = "round";
                for (b = b = 0; b < m.length; b++) c = h[b], c.indexLabelText && (c.indexLabelTextBlock.y -= c.indexLabelTextBlock.height / 2, d = 0, d = "left" === c.hemisphere ? "inside" !==
                    k.indexLabelPlacement ? -(c.indexLabelTextBlock.width + n) : -c.indexLabelTextBlock.width / 2 : "inside" !== k.indexLabelPlacement ? n : -c.indexLabelTextBlock.width / 2, c.indexLabelTextBlock.x += d, c.indexLabelTextBlock.render(!0), c.indexLabelTextBlock.x -= d, c.indexLabelTextBlock.y += c.indexLabelTextBlock.height / 2, "inside" !== c.indexLabelPlacement && 0 < c.indexLabelLineThickness && (d = c.center.x + z * Math.cos(c.midAngle), e = c.center.y + z * Math.sin(c.midAngle), a.strokeStyle = c.indexLabelLineColor, a.lineWidth = c.indexLabelLineThickness,
                        a.setLineDash && a.setLineDash(N(c.indexLabelLineDashType, c.indexLabelLineThickness)), a.beginPath(), a.moveTo(d, e), a.lineTo(c.indexLabelTextBlock.x, c.indexLabelTextBlock.y), a.lineTo(c.indexLabelTextBlock.x + ("left" === c.hemisphere ? -n : n), c.indexLabelTextBlock.y), a.stroke()), a.lineJoin = "miter");
                a.save()
            }
            ...
            function e(a) {
                for (var c = null, d = 1; d < m.length; d++)
                    if (c = (a + d + h.length) % h.length, h[c].hemisphere !== h[a].hemisphere) { c = null; break } else if (h[c].indexLabelText && c !== a && (0 > b(h[c], h[a]) || ("right" === h[a].hemisphere ? h[c].indexLabelTextBlock.y >= h[a].indexLabelTextBlock.y : h[c].indexLabelTextBlock.y <= h[a].indexLabelTextBlock.y))) break;
                else c = null;
                return c
            }
            ...
            function f(a, c, d) {
                ...
                if (0 <= a && a < m.length) {
                    var n = h[a];
                    if (0 > c && n.indexLabelTextBlock.y < p || 0 < c && n.indexLabelTextBlock.y > g) return 0;
                    var q = 0,
                        t = 0,
                        t = q = q = 0;
                    ...
                    p = 0;
                    p = "right" === n.hemisphere ? A.x + Math.sqrt(Math.pow(w, 2) - Math.pow(c - A.y, 2)) : A.x - Math.sqrt(Math.pow(w, 2) - Math.pow(c - A.y, 2));
                    ...
                    for (g = 1; g < m.length; g++)
                        if (p = (a - g + h.length) % h.length, h[p].hemisphere !== h[a].hemisphere) { p = null; break } else if (h[p].indexLabelText && h[p].hemisphere ===
                        h[a].hemisphere && p !== a && (0 > b(h[p], h[a]) || ("right" === h[a].hemisphere ? h[p].indexLabelTextBlock.y <= h[a].indexLabelTextBlock.y : h[p].indexLabelTextBlock.y >= h[a].indexLabelTextBlock.y))) break;
                    else p = null;
                    t = p;
                    q = e(a);
                    g = p = 0;
                    0 > c ? (g = "right" === n.hemisphere ? t : q, k = c, null !== g && (t = -c, c = n.indexLabelTextBlock.y - n.indexLabelTextBlock.height / 2 - (h[g].indexLabelTextBlock.y + h[g].indexLabelTextBlock.height / 2), c - t < r && (p = -t, g = f(g, p, d + 1), +g.toFixed(x) > +p.toFixed(x) && (k = c > r ? -(c - r) : -(t - (g - p)))))) : 0 < c && (g = "right" === n.hemisphere ?
                        q : t, k = c, null !== g && (t = c, c = h[g].indexLabelTextBlock.y - h[g].indexLabelTextBlock.height / 2 - (n.indexLabelTextBlock.y + n.indexLabelTextBlock.height / 2), c - t < r && (p = t, g = f(g, p, d + 1), +g.toFixed(x) < +p.toFixed(x) && (k = c > r ? c - r : t - (p - g)))));
                    k && (d = n.indexLabelTextBlock.y + k, c = 0, c = "right" === n.hemisphere ? A.x + Math.sqrt(Math.pow(w, 2) - Math.pow(d - A.y, 2)) : A.x - Math.sqrt(Math.pow(w, 2) - Math.pow(d - A.y, 2)), n.midAngle > Math.PI / 2 - u && n.midAngle < Math.PI / 2 + u ? (p = (a - 1 + h.length) % h.length, p = h[p], a = h[(a + 1 + h.length) % h.length], "left" === n.hemisphere &&
            ...
            function p() {
                ...
                a.font = "16px Arial";
                a.textBaseline = "middle";
                for (var c = a = 0, d = 0, p = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
                    ...
                    if ("inside" !== k.indexLabelPlacement) {
                        ...
                        for (var t, u, a = 0; a < m.length; a++) {
                            ...
                            if (null !== s) {
                                ...
                                if (0 > C) {
                                    ...
                                    var D = -1 * (C - u),
                                        J = F = 0;
                                    "right" === g.hemisphere ? (F = f(a, u), D = -1 * (C - F), J = f(s, D), +J.toFixed(x) <
                        ...
                        for (a = 0; a < m.length; a++) g = h[a], w = "pie" === k.type ? 0.7 * z : 0.8 * z, s = A.x + w * Math.cos(g.midAngle), u = A.y + w * Math.sin(g.midAngle), g.indexLabelTextBlock.x = s, g.indexLabelTextBlock.y = u;
                    for (a = 0; a < m.length; a++)
                        if (g = h[a], s = g.indexLabelTextBlock.measureText(), 0 !== s.height && 0 !== s.width) s = s = 0, "right" === g.hemisphere ? (s = q.x2 - (g.indexLabelTextBlock.x + g.indexLabelTextBlock.width +
                    ...
                    var H = function(a,
                        b, c) {
                        for (var d = [], e = 0; d.push(h[b]), b !== c; b = (b + 1 + m.length) % m.length);
                            ...
                            if (f = !1, t = h[k], t.indexLabelText) {
                                ...
                                if (null !== p) {
                                    ...
                                    if (q = 0 > C) {
                                        ...
                                        var l = t.indexLabelTextBlock.y - t.indexLabelTextBlock.height /
                                            2,
                                    ...
                                    q ? (0 > a && (a = k), p !== a && (c = p, d += -C), 0 === k % Math.max(m.length / 10, 3) && (f = !0)) : f = !0;
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var k =
                    ...
                    C = 0;
                a = !1;
                for (var D = 0; D < m.length; D++) C += Math.abs(m[D].y), !a && ("undefined" !== typeof m[D].indexLabel && null !== m[D].indexLabel && 0 < m[D].indexLabel.toString().length) && (a = !0), !a && ("undefined" !== typeof m[D].label && null !== m[D].label && 0 < m[D].label.toString().length) && (a = !0);
                if (0 !== C) {
                    ...
                    this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function(a) {
                        ...
                        b.fillStyle = l.backgroundColor;
                        b.fillRect(q.x1, q.y1, q.width, q.height);
                        for (var b = h[0].startAngle + 2 * Math.PI * a, c = 0; c < m.length; c++) {
                            var d = 0 === c ? h[c].startAngle : e,
                                e = d + (h[c].endAngle - h[c].startAngle),
                                f = !1;
                            e > b && (e = b, f = !0);
                            var p = m[c].color ? m[c].color : k._colorSet[c % k._colorSet.length];
                            e > d && ga(l.plotArea.ctx, h[c].center, h[c].radius, p, k.type, d, e, k.fillOpacity, h[c].percentInnerRadius);
                            if (f) break
                        }
                        g();
                        l.dispatchEvent("dataAnimationIterationEnd", { chart: l });
        ...
        l.prototype.renderFunnel =
            function(a) {
                ...
                function c() {
                    ...
                    if (0 ===
                        h) return -1;
                    for (var p = d[0] = 0, g = 0, m, n, b = b - a, p = !1, k = 0; k < x.length; k++) a = Math.abs(x[k].y) * f / h, p ? m = 0 == Number(c.toFixed(3)) ? 0 : a / c : (n = $ * $ * b * b - 4 * Math.abs($) * a, 0 > n ? (n = c, p = (b + n) * (e - g) / 2, a -= p, m = e - g, g += e - g, m += 0 == n ? 0 : a / n, g += a / n, p = !0) : (m = (Math.abs($) * b - Math.sqrt(n)) / 2, n = b - 2 * m / Math.abs($), g += m, g > e && (g -= m, n = c, p = (b + n) * (e - g) / 2, a -= p, m = e - g, g += e - g, m += a / n, g += a / n, p = !0), b = n)), d.push(m);
                    return d
                }
                ...
                function b() {
                    if (u && x) {
                        for (var a, b, c, d, e, f, k, p, g, m, n, q, t, l, r, B = [], v = [], A = { percent: null, total: null }, C = null, z = 0; z < x.length; z++) r = O[z],
                            r = "undefined" !== typeof r.x5 ? (r.y2 + r.y4) / 2 : (r.y2 + r.y3) / 2, r = h(r).x2 + 1, B[z] = M - r - U;
                        r = 0.5 * U;
                        for (var z = 0, D = x.length - 1; z < x.length || 0 <= D; z++, D--) {
                            ...
                            n = b.indexLabelLineDashType || u.indexLabelLineDashType ||
                                "solid";
                            ...
                            "inside" === u.indexLabelPlacement && (B[z] = z !== ca ? u.reversed ? O[z].x2 - O[z].x1 : O[z].x3 - O[z].x4 : O[z].x3 - O[z].x6, 20 > B[z] && (B[z] = z !== ca ? u.reversed ? O[z].x3 - O[z].x4 : O[z].x2 - O[z].x1 : O[z].x2 - O[z].x1, B[z] /= 2));
                            t = b.indexLabelMaxWidth ? b.indexLabelMaxWidth :
                                u.options.indexLabelMaxWidth ? u.indexLabelMaxWidth : B[z];
                            if (t > B[z] || 0 > t) t = B[z];
                            ...
                            b = b.indexLabelFormatter ? b.indexLabelFormatter(C) : b.indexLabel ? y.replaceKeywordsWithValue(b.indexLabel, b, u, z) : u.indexLabelFormatter ? u.indexLabelFormatter(C) : u.indexLabel ? y.replaceKeywordsWithValue(u.indexLabel, b, u, z) : b.label ?
                                b.label : "";
                            0 >= m && (m = 0);
                            1E3 > t && 1E3 - t < r && (t += 1E3 - t);
                            R.roundRect || Ba(R);
                            c = new ia(R, { fontSize: f, fontFamily: p, fontColor: e, fontStyle: k, fontWeight: g, horizontalAlign: c, textAlign: l, backgroundColor: d, maxWidth: t, maxHeight: !1 === v[z] ? q ? 4.28571429 * f : 1.5 * f : v[z], text: b, padding: da });
                            c.measureText();
                            I.push({ textBlock: c, id: u.reversed ? D : z, isDirty: !1, lineColor: a, lineThickness: m, lineDashType: n, height: c.height < c.maxHeight ? c.height : c.maxHeight, width: c.width < c.maxWidth ? c.width : c.maxWidth })
                        }
                    }
                }
                ...
                function e() {
                    ...
                    if (e)
                        for (p = I.length - 1; 0 <= p; p--) a = O[p], I[p].textBlock.maxWidth = f[f.length - (p + 1)], I[p].textBlock.measureText(), I[p].textBlock.x = M - k, c = I[p].textBlock.height < I[p].textBlock.maxHeight ? I[p].textBlock.height :
                ...
                function p() {
                    ...
                    function b() {
                        ...
                        for (var p, g = 1; g < k; g++) {
                            e = g * f;
                            for (var t = I.length - 1; 0 <= t; t--) !I[t].isDirty && (I[t].textBlock.y < e && I[t].textBlock.y + I[t].height > e) && (p = q(t), !(p >= I.length - 1) && I[t].textBlock.y + I[t].height + da > I[p].textBlock.y && (I[t].textBlock.y = I[t].textBlock.y +
                ...
                function g(a, b) { return (b < O.length ? I[b].textBlock.y : u.reversed ? na + C : sa + C) - (0 > a ? u.reversed ? sa - C : na - C : I[a].textBlock.y + I[a].height + da) }

                function l(a, b, c) {
                    var d, e, h, p = [],
                        g = C,
                        n = []; - 1 !== b && (0 <= X.indexOf(b) ? (e = X.indexOf(b), X.splice(e, 1)) : (X.push(b), X = X.sort(function(a, b) { return a - b })));
                    if (0 === X.length) p = ga;
                    else {
                    ...
                    h = function() { for (var a = [], b = 0; b < O.length; b++) a.push(p[b] - O[b].y1); return a }();
                    var q = {
                ...
                function n(a) { for (a -= 1; - 1 <= a && -1 != a && I[a].isDirty; a--); return a }
                ...
                var y = this;
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    for (var u = this.data[a.dataSeriesIndexes[0]], x = u.dataPoints, A = this.plotArea, C = 0.025 * A.width, D = 0.01 * A.width, z = 0, E = A.height - 2 * C, F = Math.min(A.width - 2 * D, 2.8 * A.height), J = !1, H = 0; H < x.length; H++)
                        if (!J && ("undefined" !== typeof x[H].indexLabel && null !== x[H].indexLabel && 0 < x[H].indexLabel.toString().length) && (J = !0), !J && ("undefined" !== typeof x[H].label && null !== x[H].label && 0 < x[H].label.toString().length) && (J = !0), !J && "function" === typeof u.indexLabelFormatter ||
                    ...
                    if (0 != u.length && (u.dataPoints && u.visible) && 0 !== x.length) {
                        ...
                        if (-1 !== H) {
                            ...
                            if (u.reversed)
                                for (G = 0; G < H.length; G++) F[G] < xa ? (a.push(L), D.push(V), ca = G) : (a.push((F[G] - na + $ * W) / $), D.push((F[G] - na + ea * Z) / ea));
                            else
                                for (G = 0; G < H.length; G++) F[G] < xa ? (a.push((F[G] - na + $ * W) / $), D.push((F[G] - na + ea * Z) / ea), ca = G) : (a.push(L), D.push(V));
                            for (G = 0; G < H.length - 1; G++) T = u.reversed ? x[x.length - 1 - G].color ? x[x.length - 1 - G].color : u._colorSet[(x.length - 1 - G) % u._colorSet.length] : x[G].color ? x[G].color : u._colorSet[G % u._colorSet.length],
                                G === ca ? O.push({ x1: a[G], y1: F[G], x2: D[G], y2: F[G], x3: V, y3: xa, x4: D[G + 1], y4: F[G + 1], x5: a[G + 1], y5: F[G + 1], x6: L, y6: xa, id: G, height: F[G + 1] - F[G], color: T }) : O.push({ x1: a[G], y1: F[G], x2: D[G], y2: F[G], x3: D[G + 1], y3: F[G + 1], x4: a[G + 1], y4: F[G + 1], id: G, height: F[G + 1] - F[G], color: T });
                            var da = 2,
                                I = [],
                                ha = !1,
                                X = [],
                            ...
                            if (J && u.visible && (b(), f(), e(), "inside" !== u.indexLabelPlacement)) { p(); for (G = 0; G < x.length; G++) I[G].isDirty || (a = I[G].textBlock.x + I[G].width, a = (M - a) / 2, 0 == G && (z = a), z > a && (z = a)); for (G = 0; G < O.length; G++) O[G].x1 += z, O[G].x2 += z, O[G].x3 += z, O[G].x4 += z, O[G].x5 && (O[G].x5 += z, O[G].x6 += z), I[G].textBlock.x += z }
                            ...
                            if (!J)
                                for (G = 0; G < x.length; G++) z = u.dataPointIds[G],
                                    a = { id: z, objectType: "dataPoint", dataPointIndex: G, dataSeriesIndex: 0, funnelSection: O[u.reversed ? x.length - 1 - G : G] }, y._eventManager.objectMap[z] = a;
                            ...
                            this.funnelPyramidClickHandler = function(a) {
                                ...
                                if (!ha && !y.isAnimating && (s(a.dataSeries.explodeOnClick) || a.dataSeries.explodeOnClick) && (b = u.reversed ? x.length - 1 - a.dataPointIndex : a.dataPointIndex, 0 <= b)) {
                                    a = b;
                                    if ("funnel" === u.type || "pyramid" === u.type) u.reversed ? x[x.length - 1 - a].exploded =
        ...
        l.prototype.exportChart = function(a) {
            ...
            if (b && d && c) {
                ...
                if ("undefined" !== typeof Blob && new Blob) {
                    for (var p = b.replace(/^data:[a-z\/]*;base64,/, ""), p = atob(p), g = new ArrayBuffer(p.length), g = new Uint8Array(g), l = 0; l < p.length; l++) g[l] = p.charCodeAt(l);
        ...
        l.prototype.replaceKeywordsWithValue = function(a, d, c, b, e) {
            ...
            if ((0 <= c.type.indexOf("stacked") || "pie" === c.type || "doughnut" === c.type || "funnel" === c.type || "pyramid" === c.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
                ...
                do {
                    ...
                    a = a.replace("#total", ea(g, c.yValueFormatString ? c.yValueFormatString : "#,##0.########", f._cultureInfo))
        ...
        F.prototype.setLayout = function() {
            var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart,
                ...
                f = 0,
                p = 0,
                g = this.markerMargin = this.chart.options.legend && !s(this.chart.options.legend.markerMargin) ?
                this.chart.options.legend.markerMargin : 0.3 * this.fontSize;
            this.height = 0;
            var l = [],
                k = [];
            if ("top" === this.verticalAlign || "bottom" === this.verticalAlign) this.orientation = "horizontal", c = this.verticalAlign, f = this.maxWidth = null !== this.maxWidth ? this.maxWidth : d.width, p = this.maxHeight = null !== this.maxHeight ? this.maxHeight : 0.5 * d.height;
                ...
                if (n.dataPoints && n.dataPoints.length)
                    if ("pie" !== n.type && "doughnut" !== n.type && "funnel" !== n.type && "pyramid" !== n.type) {
                        var q = n.legendMarkerType = n.legendMarkerType ? n.legendMarkerType : "line" !== n.type && "stepLine" !== n.type && "spline" !== n.type && "scatter" !== n.type && "bubble" !== n.type || !n.markerType ?
                            "error" === n.type && n._linkedSeries ? n._linkedSeries.legendMarkerType ? n._linkedSeries.legendMarkerType : H.getDefaultLegendMarker(n._linkedSeries.type) : H.getDefaultLegendMarker(n.type) : n.markerType,
                        ...
                        for (var x = 0; x < n.dataPoints.length; x++) {
                            var A = n.dataPoints[x],
                                ...
                                h = A.legendText ? A.legendText : n.legendText ? n.legendText : this.itemTextFormatter ? this.itemTextFormatter({ chart: this.chart, legend: this.options, dataSeries: n, dataPoint: A }) : A.name ? A.name : "DataPoint: " + (x + 1),
                                r = A.legendMarkerColor ? A.legendMarkerColor :
                                n.legendMarkerColor ? n.legendMarkerColor : A.color ? A.color : n.color ? n.color : n._colorSet[x % n._colorSet.length],
                                ...
                                u = A.legendMarkerBorderThickness ? A.legendMarkerBorderThickness : n.legendMarkerBorderThickness ? n.legendMarkerBorderThickness : A.markerBorderThickness || n.markerBorderThickness ? Math.max(1, Math.round(0.2 * w)) : 0,
            ...
            if (0 < l.length) {
                n = null;
                r = h = A = x = 0;
                A = null !== this.itemWidth ? null !== this.itemMaxWidth ? Math.min(this.itemWidth, this.itemMaxWidth, f) : this.itemMaxWidth = Math.min(this.itemWidth, f) : null !== this.itemMaxWidth ? Math.min(this.itemMaxWidth, f) : this.itemMaxWidth =
                    f;
                ...
                for (m = 0; m < l.length; m++) {
                    ...
                    if (!(0 >= p || "undefined" === typeof p || 0 >= v || "undefined" === typeof v)) {
                        if ("horizontal" === this.orientation) {
                            ...
                            if (!n || n.width + Math.round(q.textBlock.width + w + g + (0 === n.width ? 0 : this.horizontalSpacing) + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0)) > f) n = { items: [], width: 0 }, k.push(n), this.height += h, h = 0;
                            ...
                            new ia(this.ctx, { x: 0, y: 0, maxWidth: A, maxHeight: !0 === this.itemWrap ? p : 1.5 * this.fontSize, angle: 0, text: q.text, horizontalAlign: "left", fontSize: this.fontSize, fontFamily: this.fontFamily, fontWeight: this.fontWeight, fontColor: this.fontColor, fontStyle: this.fontStyle, textBaseline: "middle" }), q.textBlock.measureText(), null !== this.itemWidth && (q.textBlock.width = this.itemWidth - (w + g + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0))), this.height < p - this.lineHeight ? (n = {
                                items: [],
                                width: 0
                            }, k.push(n)) : (n = k[x], x = (x + 1) % k.length), this.height += q.textBlock.height;
            ...
            this.items = l;
            for (m = 0; m < this.items.length; m++) q = l[m], q.id = ++this.chart._eventManager.lastObjectId, this.chart._eventManager.objectMap[q.id] = { id: q.id, objectType: "legendItem", legendItemIndex: m, dataSeriesIndex: q.dataSeriesIndex, dataPointIndex: q.dataPointIndex };
            this.markerSize = w;
            this.rows = k;
        ...
        F.prototype.render = function() {
            ...
            for (var g = 0, l = 0; l < p.length; l++) {
                for (var k = p[l], m = 0, n = 0; n < k.items.length; n++) {
                    ...
                    this.ctx.clip();
                    if ("line" === q.chartType || "stepLine" === q.chartType || "spline" === q.chartType) this.ctx.strokeStyle = q.lineColor, this.ctx.lineWidth = Math.ceil(this.lineHeight / 8), this.ctx.beginPath(), this.ctx.moveTo(h - 0.1 * this.lineHeight, r + this.lineHeight / 2), this.ctx.lineTo(h + 0.85 * this.lineHeight, r + this.lineHeight / 2), this.ctx.stroke(), s -=
                        0.1 * this.lineHeight;
        ...
        H.prototype.getDataPointAtX = function(a, d) {
            ...
            for (;;) {
                ...
                } else if (0 > m - e && m + e >= this.dataPoints.length) break; - 1 === p ? (e++, p = 1) : p = -1
            }
        ...
        H.prototype.getDataPointAtXY = function(a, d, c) {
            ...
            if ("none" !== this.chart.plotInfo.axisPlacement)
                if (n = (this.chart.axisX[0] ? this.chart.axisX[0] : this.chart.axisX2[0]).getXValueAt({ x: a, y: d }), this.axisX.logarithmic) var q = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x),
                ...
                if (0 <= f && f < this.dataPoints.length) {
                    ...
                    if (q) {
                        switch (this.type) {
                            ...
                            case "error":
                                a >=
                                    q.x1 && (a <= q.x2 && d >= q.y1 && d <= q.y2) && (b.push({ dataPoint: h, dataPointIndex: f, dataSeries: this, distance: Math.min(Math.abs(q.x1 - a), Math.abs(q.x2 - a), Math.abs(q.y1 - d), Math.abs(q.y2 - d)) }), g = !0);
                                break;
                            case "line":
                            case "stepLine":
                            case "spline":
                            ...
                            case "scatter":
                                ...
                                r <= w && b.push({ dataPoint: h, dataPointIndex: f, dataSeries: this, distance: r });
                                q =
                                    Math.abs(q.x1 - a);
                                q <= l ? l = q : 0 < p ? k++ : m++;
                                r <= s / 2 && (g = !0);
                            ...
                            case "doughnut":
                                ...
                                r < q.radius && r > w && (r = Math.atan2(d - s.y, a - s.x), 0 > r && (r += 2 * Math.PI), r = Number(((180 * (r / Math.PI) % 360 + 360) % 360).toFixed(12)), s = Number(((180 * (q.startAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), w = Number(((180 * (q.endAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), 0 === w && 1 < q.endAngle && (w = 360), s >= w && 0 !== h.y && (w += 360, r < s && (r += 360)), r > s && r < w && (b.push({
                                    dataPoint: h,
                                    dataPointIndex: f,
                                    dataSeries: this,
                                    distance: 0
                            ...
                            case "boxAndWhisker":
                                if (a >=
                                    q.x1 - q.borderThickness / 2 && a <= q.x2 + q.borderThickness / 2 && d >= q.y4 - q.borderThickness / 2 && d <= q.y1 + q.borderThickness / 2 || Math.abs(q.x2 - a + q.x1 - a) < q.borderThickness && d >= q.y1 && d <= q.y4) b.push({ dataPoint: h, dataPointIndex: f, dataSeries: this, distance: Math.min(Math.abs(q.x1 - a), Math.abs(q.x2 - a), Math.abs(q.y2 - d), Math.abs(q.y3 - d)) }), g = !0;
                                break;
                            case "candlestick":
                                if (a >= q.x1 - q.borderThickness / 2 && a <= q.x2 + q.borderThickness / 2 && d >= q.y2 - q.borderThickness / 2 && d <= q.y3 + q.borderThickness / 2 || Math.abs(q.x2 - a + q.x1 - a) < q.borderThickness &&
                                    d >= q.y1 && d <= q.y4) b.push({ dataPoint: h, dataPointIndex: f, dataSeries: this, distance: Math.min(Math.abs(q.x1 - a), Math.abs(q.x2 - a), Math.abs(q.y2 - d), Math.abs(q.y3 - d)) }), g = !0;
                                break;
                            case "ohlc":
        ...
        E.prototype.createLabels = function() {
            ...
            var n = this.scaleBreaks ? this.scaleBreaks._appliedBreaks : [],
                q = n.length ? s(this.scaleBreaks.firstBreakIndex) ?
            ...
            if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
                ...
                if (this.logarithmic && !this.equidistantInterval)
                    for (this.logLabelValues || (this.logLabelValues = [], this.createExtraLabelsForLog()), b = 0, h = q; b < this.logLabelValues.length; b++)
                        if (c =
            ...
            else if ("left" === this._position || "right" === this._position) g = this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length ? this.lineCoordinates.height *
                    ...
                    if (f = 0.9 * g >> 0, q = 0, !this.chart.panEnabled && 1 <= this._labels.length) {
                        ...
                        for (c = 0; c < this._labels.length; c++)
                            if (!this._labels[c].breaksLabelType) {
                                ...
                                for (var v, h = a.text.split(" "), b = 0; b < h.length; b++) m = h[b], this.ctx.font = a.fontStyle + " " +
                        ...
                        for (c = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; c < this._labels.length; c++)
                            if (!this._labels[c].breaksLabelType) {
                                ...
                                if (s(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                                    if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? p : Math.min((b - f * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), b), m = (k - (l + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(-25))) / Math.sin(Math.PI /
                                        ...
                                        if (s(this.options.labelWrap))
                                            if (!s(this.options.labelMaxWidth)) this.options.labelMaxWidth <
                                                f ? (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = b) : (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = p);
                                            else if (!s(d))
                                            if (b = r.width + d.width >> 0, h = this.labelFontSize, q < f) b - 2 * f > n && (n = b - 2 * f, b >= 2 * f && b < 2.2 * f ? (this.sessionVariables.labelMaxWidth = f, s(this.options.labelFontSize) && 12 < h && (h = Math.floor(12 / 13 * h), a.measureText()), this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ?
                                                ...
                                                h : this.options.labelFontSize, this.sessionVariables.labelAngle = this.labelAngle) : b >= 3.2 * f && b < 3.6 * f ? (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelMaxWidth = m, this.sessionVariables.labelFontSize = this.labelFontSize) : b > 3.6 * f && b < 5 * f ? (s(this.options.labelFontSize) && 12 < h && (h = Math.floor(12 / 13 * h), a.measureText()), this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? h : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = m) : b > 5 * f && (this.sessionVariables.labelWrap = !0, this.sessionVariables.labelMaxWidth = f, this.sessionVariables.labelFontSize = h, this.sessionVariables.labelMaxHeight = p, this.sessionVariables.labelAngle = this.labelAngle));
                                                ...
                                                q + this._labels[v - 1].textBlock.measureText().width - 2 * f > n)) n = 0 === v ? q + this._labels[v + 1].textBlock.measureText().width - 2 * f : q + this._labels[v - 1].textBlock.measureText().width - 2 * f, this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? h : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = m;
                                        else if (0 === n)
                                            for (this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? h : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, b = 0; b < this._labels.length; b++) a = this._labels[b].textBlock, a.maxWidth = this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, q), m), r = a.measureText(), b < this._labels.length - 1 && (h = b + 1, d = this._labels[h].textBlock, d.maxWidth = this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, q), m), d = d.measureText(), r.width + d.width >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25))
                                    }
        ...
        E.setLayout = function(a, d, c, b, e, f) {
            var p, g, l, k, m = a[0] ? a[0].chart : d[0].chart,
                n = m.isNavigator ? 0 : 10,
                q = m._axes;
            if (a && 0 < a.length)
                for (var h = 0; h < a.length; h++) a[h] && a[h].calculateAxisParameters();
            if (d && 0 < d.length)
            ...
            for (h = 0; h < q.length; h++)
                if (q[h] && q[h].scaleBreaks &&
                    q[h].scaleBreaks._appliedBreaks.length)
                    for (var r = q[h].scaleBreaks._appliedBreaks, w = 0; w < r.length && !(r[w].startValue > q[h].viewportMaximum); w++) r[w].endValue < q[h].viewportMinimum || (s(q[h].scaleBreaks.firstBreakIndex) && (q[h].scaleBreaks.firstBreakIndex = w), r[w].startValue >= q[h].viewPortMinimum && (q[h].scaleBreaks.lastBreakIndex = w));
            for (var v = w = 0, u = 0, x = 0, A = 0, y = 0, D = 0, z, E, F = g = 0, H, J, K, r = H = J = K = !1, h = 0; h < q.length; h++) q[h] && q[h].title && (q[h]._titleTextBlock = new ia(q[h].ctx, {
                text: q[h].title,
                horizontalAlign: "center",
            ...
            if ("normal" === e) {
                for (var x = [], A = [], y = [], D = [], M = [], N = [], P = [], R = []; 4 >
                    ...
                    var G = 0,
                        ...
                        $ = 0;
                    if (c && 0 < c.length)
                        for (y = [], h = O = 0; h < c.length; h++) y.push(Math.ceil(c[h] ? c[h].createLabelsAndCalculateWidth() : 0)), O += y[h], L += c[h] && !m.isNavigator ? c[h].margin : 0;
                    else y.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateWidth() : 0));
                    P.push(y);
                    if (b && 0 < b.length)
                        for (D = [], h = $ = 0; h < b.length; h++) D.push(Math.ceil(b[h] ? b[h].createLabelsAndCalculateWidth() : 0)), $ += D[h], Z += b[h] ? b[h].margin : 0;
                    ...
                    if (d && 0 < d.length)
                        for (h = 0; h < d.length; h++) d[h].lineCoordinates.x1 = Math.round(f.x1 + O + L), d[h].lineCoordinates.x2 =
                    ...
                    if (c && 0 < c.length)
                        for (h = 0; h < c.length; h++) L = m.isNavigator ? 0 : 10, c[h] && (p = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), L = c[h]._labels && 0 < c[h]._labels.length ? c[h]._labels[c[h]._labels.length - 1].textBlock.height / 2 : n, g = Math.round(f.y1 + V + W < Math.max(L, n) ? Math.max(L, n) : f.y1 + V + W), l = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), L = 0 < a.length ? 0 : c[h]._labels && 0 < c[h]._labels.length ? c[h]._labels[0].textBlock.height /
                            2 : n, k = Math.round(f.y2 - T - e - L), c[h].lineCoordinates = { x1: p - U, y1: g, x2: l - U, y2: k, height: Math.abs(k - g) }, "inside" === c[h].labelPlacement && 0 < h && (c[h].lineCoordinates.x1 = c[h].lineCoordinates.x1 - (y[h] - (c[h]._titleTextBlock ? c[h]._titleTextBlock.height : 0)) + ("outside" === c[h].tickPlacement ? c[h].tickLength : 0), c[h].lineCoordinates.x2 = c[h].lineCoordinates.x1 + c[h].lineThickness / 2), c[h].bounds = { x1: p - (y[h] + U), y1: g, x2: l, y2: k, width: l - p, height: k - g }, c[h].title && (c[h]._titleTextBlock.maxWidth = 0 < c[h].titleMaxWidth && c[h].titleMaxWidth <
                                c[h].lineCoordinates.height ? c[h].titleMaxWidth : c[h].lineCoordinates.height), U += y[h] + c[h].margin);
                    if (b && 0 < b.length)
                        for (h = 0; h < b.length; h++) b[h] && (p = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2), l = Math.round(p), L = b[h]._labels && 0 < b[h]._labels.length ? b[h]._labels[b[h]._labels.length - 1].textBlock.height / 2 : 0, g = Math.round(f.y1 + V + W < Math.max(L, n) ? Math.max(L, n) : f.y1 + V + W), L = 0 < a.length ? 0 : b[h]._labels && 0 < b[h]._labels.length ? b[h]._labels[0].textBlock.height / 2 : 0, k = Math.round(f.y2 - (T + e + L)), b[h].lineCoordinates = { x1: p + X, y1: g, x2: p + X, y2: k, height: Math.abs(k - g) }, "inside" === b[h].labelPlacement && 0 < h && (b[h].lineCoordinates.x1 = b[h].lineCoordinates.x1 + (D[h] - (b[h]._titleTextBlock ? b[h]._titleTextBlock.height : 0)) - ("outside" === b[h].tickPlacement ? b[h].tickLength : 0) - 2, b[h].lineCoordinates.x2 = b[h].lineCoordinates.x1 + b[h].lineThickness / 2), b[h].bounds = { x1: p, y1: g, x2: l + (D[h] + X), y2: k, width: l - p, height: k - g }, b[h].title && (b[h]._titleTextBlock.maxWidth = 0 < b[h].titleMaxWidth && b[h].titleMaxWidth < b[h].lineCoordinates.height ? b[h].titleMaxWidth :
                            b[h].lineCoordinates.height), X += D[h] + b[h].margin);
                    if (a && 0 < a.length)
                        for (h = 0; h < a.length; h++) a[h] && (a[h].calculateValueToPixelConversionParameters(), a[h].calculateBreaksSizeInValues(), a[h]._labels && 1 < a[h]._labels.length && (z = (a[h].logarithmic ? Math.log(a[h]._labels[1].position / a[h].viewportMinimum) / a[h].conversionParameters.lnLogarithmBase : a[h]._labels[1].position - a[h].viewportMinimum) * Math.abs(a[h].conversionParameters.pixelPerUnit) + a[h].lineCoordinates.x1, p = a[h]._labels[a[h]._labels.length - ("dateTime" ===
                            a[h].valueType ? 2 : 1)].position, p = a[h].getApparentDifference(a[h].viewportMinimum, p), E = a[h].logarithmic ? (1 < p ? Math.log(p) / a[h].conversionParameters.lnLogarithmBase * Math.abs(a[h].conversionParameters.pixelPerUnit) : 0) + a[h].lineCoordinates.x1 : (0 < p ? p * Math.abs(a[h].conversionParameters.pixelPerUnit) : 0) + a[h].lineCoordinates.x1));
                    if (d && 0 < d.length)
                        for (h = 0; h < d.length; h++) d[h].calculateValueToPixelConversionParameters(), d[h].calculateBreaksSizeInValues(), d[h]._labels && 1 < d[h]._labels.length && (z = (d[h].logarithmic ?
                    ...
                    if (0 < w) {
                        if (a && 0 < a.length)
                            for (h = 0; h < a.length; h++) r = M[w - 1][h] === M[w][h] ? !0 : !1;
                        else r = !0;
                        if (d && 0 < d.length)
                            for (h = 0; h < d.length; h++) H = N[w - 1][h] === N[w][h] ? !0 : !1;
                        else H = !0;
                        if (c && 0 < c.length)
                            for (h = 0; h < c.length; h++) J = P[w - 1][h] === P[w][h] ? !0 : !1;
                        else J = !0;
                        if (b && 0 < b.length)
                            for (h = 0; h < b.length; h++) K = R[w -
                                1][h] === R[w][h] ? !0 : !1;
                        else K = !0
                    }
                    if (r && H && J && K) break;
                ...
                if (a && 0 < a.length)
                    for (h = 0; h < a.length; h++) a[h].calculateStripLinesThicknessInValues(), a[h].calculateBreaksInPixels();
                if (d && 0 < d.length)
                    for (h = 0; h < d.length; h++) d[h].calculateStripLinesThicknessInValues(), d[h].calculateBreaksInPixels();
                if (c && 0 < c.length)
                    for (h = 0; h < c.length; h++) c[h].calculateStripLinesThicknessInValues(), c[h].calculateBreaksInPixels();
                if (b && 0 < b.length)
                    for (h = 0; h < b.length; h++) b[h].calculateStripLinesThicknessInValues(), b[h].calculateBreaksInPixels()
            } else {
                n = [];
                z = [];
                F = [];
                ...
                for (N = []; 4 > w;) {
                    ...
                    if (a && 0 < a.length)
                        for (F = [], h = X = 0; h < a.length; h++) F.push(Math.ceil(a[h] ? a[h].createLabelsAndCalculateWidth() : 0)), X += F[h], e += a[h] && !m.isNavigator ? a[h].margin : 0;
                    else F.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() : 0));
                    M.push(F);
                    if (d && 0 < d.length)
                        for (v = [], h = T = 0; h < d.length; h++) v.push(Math.ceil(d[h] ? d[h].createLabelsAndCalculateWidth() : 0)), T += v[h], W += d[h] ? d[h].margin : 0;
                    else v.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateWidth() :
                        0));
                    N.push(v);
                    if (c && 0 < c.length)
                        for (h = 0; h < c.length; h++) c[h].lineCoordinates = {}, p = Math.round(f.x1 + X + e), l = Math.round(f.x2 - T - W > m.width - 10 ? m.width - 10 : f.x2 - T - W), c[h].labelAutoFit && !s(x) && (0 < !a.length && (p = 0 > c[h].labelAngle ? Math.max(p, x) : 0 === c[h].labelAngle ? Math.max(p, x / 2) : p), 0 < !d.length && (l = 0 < c[h].labelAngle ? l - A / 2 : 0 === c[h].labelAngle ? l - A / 2 : l)), c[h].lineCoordinates.x1 = p, c[h].lineCoordinates.x2 = l, c[h].lineCoordinates.width = Math.abs(l - p), c[h].title && (c[h]._titleTextBlock.maxWidth = 0 < c[h].titleMaxWidth && c[h].titleMaxWidth <
                            c[h].lineCoordinates.width ? c[h].titleMaxWidth : c[h].lineCoordinates.width);
                    if (b && 0 < b.length)
                        for (h = 0; h < b.length; h++) b[h].lineCoordinates = {}, p = Math.round(f.x1 + X + e), l = Math.round(f.x2 - T - W > b[h].chart.width - 10 ? b[h].chart.width - 10 : f.x2 - T - W), b[h] && b[h].labelAutoFit && !s(y) && (0 < !a.length && (p = 0 < b[h].labelAngle ? Math.max(p, y) : 0 === b[h].labelAngle ? Math.max(p, y / 2) : p), 0 < !d.length && (l -= D / 2)), b[h].lineCoordinates.x1 = p, b[h].lineCoordinates.x2 = l, b[h].lineCoordinates.width = Math.abs(l - p), b[h].title && (b[h]._titleTextBlock.maxWidth =
                            0 < b[h].titleMaxWidth && b[h].titleMaxWidth < b[h].lineCoordinates.width ? b[h].titleMaxWidth : b[h].lineCoordinates.width);
                    if (c && 0 < c.length)
                        for (n = [], h = U = 0; h < c.length; h++) n.push(Math.ceil(c[h] ? c[h].createLabelsAndCalculateHeight() : 0)), U += n[h] + c[h].margin, L += c[h].margin;
                    else n.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateHeight() : 0));
                    E.push(n);
                    if (b && 0 < b.length)
                        for (z = [], h = S = 0; h < b.length; h++) z.push(Math.ceil(b[h] ? b[h].createLabelsAndCalculateHeight() : 0)), S += z[h], Z += b[h].margin;
                    else z.push(Math.ceil(b[0] ?
                        b[0].createLabelsAndCalculateHeight() : 0));
                    u.push(z);
                    if (c && 0 < c.length)
                        for (h = 0; h < c.length; h++) 0 < c[h]._labels.length && (k = c[h]._labels[0], g = c[h]._labels[c[h]._labels.length - 1], x = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - g.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)), A = g.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(g.textBlock.angle)) + (g.textBlock.height - g.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(g.textBlock.angle)));
                    if (b && 0 < b.length)
                        for (h = 0; h < b.length; h++) b[h] && 0 < b[h]._labels.length && (k = b[h]._labels[0], g = b[h]._labels[b[h]._labels.length - 1], y = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - g.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)), D = g.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(g.textBlock.angle)) + (g.textBlock.height - g.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(g.textBlock.angle)));
                    if (m.panEnabled)
                        for (h = 0; h < c.length; h++) n[h] = s(m.sessionVariables.axisY.height) ?
                            m.sessionVariables.axisY.height = n[h] : m.sessionVariables.axisY.height;
                    else
                        for (h = 0; h < c.length; h++) m.sessionVariables.axisY.height = n[h];
                    if (c && 0 < c.length)
                        for (h = c.length - 1; 0 <= h; h--) g = Math.round(f.y2), k = Math.round(f.y2 > c[h].chart.height ? c[h].chart.height : f.y2), c[h].lineCoordinates.y1 = g - (n[h] + c[h].margin + V), c[h].lineCoordinates.y2 = g - (n[h] + c[h].margin + V), "inside" === c[h].labelPlacement && 0 < h && (c[h].lineCoordinates.y1 = c[h].lineCoordinates.y1 + n[h] - (c[h]._titleTextBlock ? c[h]._titleTextBlock.height : 0) - ("inside" ===
                            c[h].tickPlacement ? c[h].tickLength : 0), c[h].lineCoordinates.y2 = c[h].lineCoordinates.y1 + c[h].lineThickness / 2), c[h].bounds = { x1: p, y1: g - (n[h] + V + c[h].margin), x2: l, y2: k - (V + c[h].margin), width: l - p, height: n[h] }, c[h].title && (c[h]._titleTextBlock.maxWidth = 0 < c[h].titleMaxWidth && c[h].titleMaxWidth < c[h].lineCoordinates.width ? c[h].titleMaxWidth : c[h].lineCoordinates.width), V += n[h] + c[h].margin;
                    if (b && 0 < b.length)
                        for (h = b.length - 1; 0 <= h; h--) b[h] && (g = Math.round(f.y1), k = Math.round(f.y1 + (z[h] + b[h].margin + G)), b[h].lineCoordinates.y1 =
                            k, b[h].lineCoordinates.y2 = k, "inside" === b[h].labelPlacement && 0 < h && (b[h].lineCoordinates.y1 = k - z[h] + (b[h]._titleTextBlock ? b[h]._titleTextBlock.height : 0)), b[h].bounds = { x1: p, y1: g + (b[h].margin + G), x2: l, y2: k, width: l - p, height: S }, b[h].title && (b[h]._titleTextBlock.maxWidth = 0 < b[h].titleMaxWidth && b[h].titleMaxWidth < b[h].lineCoordinates.width ? b[h].titleMaxWidth : b[h].lineCoordinates.width), G += z[h] + b[h].margin);
                    if (a && 0 < a.length)
                        for (h = 0; h < a.length; h++) {
                            L = a[h]._labels && 0 < a[h]._labels.length ? a[h]._labels[0].textBlock.fontSize /
                                2 : 0;
                            p = Math.round(f.x1 + e);
                            g = b && 0 < b.length ? Math.round(b[0] ? b[0].lineCoordinates.y2 : f.y1 < Math.max(L, 10) ? Math.max(L, 10) : f.y1) : f.y1 < Math.max(L, 10) ? Math.max(L, 10) : f.y1;
                            ...
                            if (c && 0 < c.length)
                                for (L = 0; L < c.length; L++) c[L] && c[L].labelAutoFit && (l = 0 > c[L].labelAngle ? Math.max(l, x) : 0 === c[L].labelAngle ? Math.max(l, x / 2) : l, p =
                                    0 > c[L].labelAngle || 0 === c[L].labelAngle ? l - X : p);
                            if (b && 0 < b.length)
                                for (L = 0; L < b.length; L++) b[L] && b[L].labelAutoFit && (l = b[L].lineCoordinates.x1, p = l - X);
                            a[h].lineCoordinates = { x1: l - P, y1: g, x2: l - P, y2: k, height: Math.abs(k - g) };
                            "inside" === a[h].labelPlacement && 0 < h && (a[h].lineCoordinates.x1 = a[h].lineCoordinates.x1 - (F[h] - (a[h]._titleTextBlock ? a[h]._titleTextBlock.height : 0)) + ("outside" === a[h].tickPlacement ? a[h].tickLength : 0), a[h].lineCoordinates.x2 = a[h].lineCoordinates.x1 + a[h].lineThickness / 2);
                            a[h].bounds = {
                                x1: l - (F[h] +
                                    P),
                                y1: g,
                    ...
                    if (d && 0 < d.length)
                        for (h = 0; h < d.length; h++) {
                            ...
                            p = Math.round(f.x1 - e);
                            g = b && 0 < b.length ? Math.round(b[0] ? b[0].lineCoordinates.y2 : f.y1 <
                                Math.max(L, 10) ? Math.max(L, 10) : f.y1) : f.y1 < Math.max(L, 10) ? Math.max(L, 10) : f.y1;
                            l = Math.round(f.x2 - T - W);
                            k = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - U > m.height - Math.max(L, 10) ? m.height - Math.max(L, 10) : f.y2 - U) : f.y2 > m.height - Math.max(L, 10) ? m.height - Math.max(L, 10) : f.y2;
                            if (c && 0 < c.length)
                                for (L = 0; L < c.length; L++) c[L] && c[L].labelAutoFit && (l = 0 > c[L].labelAngle ? Math.max(l, x) : 0 === c[L].labelAngle ? Math.max(l, x / 2) : l, p = 0 > c[L].labelAngle || 0 === c[L].labelAngle ? l - T : p);
                            if (b && 0 < b.length)
                                for (L = 0; L < b.length; L++) b[L] &&
                                    b[L].labelAutoFit && (l = b[L].lineCoordinates.x2, p = l - T);
                            d[h].lineCoordinates = { x1: l + R, y1: g, x2: l + R, y2: k, height: Math.abs(k - g) };
                            "inside" === d[h].labelPlacement && 0 < h && (d[h].lineCoordinates.x1 = d[h].lineCoordinates.x1 + (v[h] - (d[h]._titleTextBlock ? d[h]._titleTextBlock.height : 0) - 2) - ("outside" === d[h].tickPlacement ? d[h].tickLength : 0), d[h].lineCoordinates.x2 = d[h].lineCoordinates.x1 + d[h].lineThickness / 2);
                            d[h].bounds = { x1: d[h].lineCoordinates.x1, y1: g, x2: l + v[h] + R, y2: k, width: l - p, height: k - g };
                            d[h].title && (d[h]._titleTextBlock.maxWidth =
                                0 < d[h].titleMaxWidth && d[h].titleMaxWidth < d[h].lineCoordinates.height ? d[h].titleMaxWidth : d[h].lineCoordinates.height);
                    ...
                    if (0 < w) {
                        ...
                        if (d && 0 < d.length)
                            for (h = 0; h < d.length; h++) H = N[w - 1][h] === N[w][h] ? !0 :
                                !1;
                        else H = !0;
                        if (c && 0 < c.length)
                            for (h = 0; h < c.length; h++) J = E[w - 1][h] === E[w][h] ? !0 : !1;
                        else J = !0;
                        if (b && 0 < b.length)
                            for (h = 0; h < b.length; h++) K = u[w - 1][h] === u[w][h] ? !0 : !1;
                        else K = !0
                    }
                    if (r && H && J && K) break;
                    w++
                ...
                if (b && 0 < b.length)
                    for (h = 0; h < b.length; h++) b[h].calculateStripLinesThicknessInValues(), b[h].calculateBreaksInPixels();
                if (a && 0 < a.length)
                    for (h = 0; h < a.length; h++) a[h].calculateStripLinesThicknessInValues(),
        ...
        E.render = function(a, d, c, b, e) {
            ...
            e.clip();
            if (a && 0 < a.length)
                for (g = 0; g < a.length; g++) a[g].renderStripLinesOfThicknessType("value");
            if (d && 0 < d.length)
                for (g = 0; g < d.length; g++) d[g].renderStripLinesOfThicknessType("value");
            if (c && 0 < c.length)
                for (g = 0; g < c.length; g++) c[g].renderStripLinesOfThicknessType("value");
            if (b && 0 < b.length)
                for (g = 0; g < b.length; g++) b[g].renderStripLinesOfThicknessType("value");
            if (a && 0 < a.length)
            ...
            e.restore();
            if (a && 0 < a.length)
                for (g = 0; g < a.length; g++) a[g].renderGrid(),
                    w && (a[g].createMask(), a[g].renderBreaksBackground());
            if (d && 0 < d.length)
                for (g = 0; g < d.length; g++) d[g].renderGrid(), w && (d[g].createMask(), d[g].renderBreaksBackground());
            if (c && 0 < c.length)
                for (g = 0; g < c.length; g++) c[g].renderGrid(), w && (c[g].createMask(), c[g].renderBreaksBackground());
            if (b && 0 < b.length)
                for (g = 0; g < b.length; g++) b[g].renderGrid(), w && (b[g].createMask(), b[g].renderBreaksBackground());
            if (a && 0 < a.length)
            ...
            if (a && 0 < a.length)
                for (g = 0; g < a.length; g++) a[g].renderStripLinesOfThicknessType("pixel");
            if (d && 0 < d.length)
                for (g = 0; g < d.length; g++) d[g].renderStripLinesOfThicknessType("pixel");
            if (c && 0 < c.length)
                for (g = 0; g < c.length; g++) c[g].renderStripLinesOfThicknessType("pixel");
            if (b && 0 < b.length)
                for (g = 0; g < b.length; g++) b[g].renderStripLinesOfThicknessType("pixel")
        };
        ...
        E.prototype.renderLabelsTicksAndTitle = function() {
                ...
                if ("bottom" === this._position || "top" === this._position)
                    if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                        for (var c = [], e = 0 !== this.labelAngle && 360 !== this.labelAngle ? 1 : 1.2, g, l = this.viewportMaximum, s = this.lineCoordinates.width / Math.log(this.range), k = this._labels.length -
                            ...
                            n.position > this.viewportMaximum || !(k === this._labels.length - 1 || g < Math.log(l / n.position) * s / e) || (c.push(n), l = n.position, g = n.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + n.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
                        }
                        this._labels = c
                    } else {
                        for (k = 0; k < this._labels.length; k++) n = this._labels[k], n.position < this.viewportMinimum || (g = n.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + n.textBlock.height *
                            Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)), c += g);
                ...
                if ("left" === this._position || "right" === this._position)
                    if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                        for (var c = [], m, l = this.viewportMaximum, s = this.lineCoordinates.height / Math.log(this.range), k = this._labels.length - 1; 0 <= k; k--) {
                            n = this._labels[k];
                            if (n.position < this.viewportMinimum) break;
                            n.position > this.viewportMaximum || !(k === this._labels.length - 1 || m < Math.log(l / n.position) *
            ...
            if ("bottom" === this._position) {
                ...
                "inside" === this.tickPlacement && this.chart.addEventListener("dataAnimationEnd", function() {
                    for (k = 0; k < a._labels.length; k++)
                        if (n = a._labels[k], !(n.position < a.viewportMinimum || n.position > a.viewportMaximum) && (q = a.getPixelCoordinatesOnAxis(n.position),
                                a.tickThickness)) {
                            a.ctx.lineWidth = a.tickThickness;
                            a.ctx.strokeStyle = a.tickColor;
                            var b = 1 === a.ctx.lineWidth % 2 ? (q.y << 0) + 0.5 : q.y << 0;
            ...
            f =
                0;
            if ("inside" === this.labelPlacement) this.chart.addEventListener("dataAnimationEnd", function() { for (k = 0; k < a._labels.length; k++) n = a._labels[k], n.position < a.viewportMinimum || (n.position > a.viewportMaximum || d && 0 !== f++ % 2 && a.labelAutoFit) || (a.ctx.save(), a.ctx.beginPath(), n.textBlock.render(!0), a.ctx.restore()) }, this);
            else
                for (k = 0; k < this._labels.length; k++) n = this._labels[k], n.position < this.viewportMinimum || (n.position > this.viewportMaximum || d && 0 !== f++ % 2 && this.labelAutoFit) || n.textBlock.render(!0)
        };
        ...
        E.prototype.renderStripLinesOfThicknessType = function(a) {
            if (this.stripLines &&
                ...
                for (var d = this, c, b = 0, e = 0, f = !1, g = !1, l = [], w = [], g = !1, b = 0; b < this.stripLines.length; b++) {
                    var k = this.stripLines[b];
                    k._thicknessType === a && ("pixel" === a && (k.value < this.viewportMinimum || k.value > this.viewportMaximum || s(k.value) || isNaN(this.range)) || "value" === a && (k.startValue <= this.viewportMinimum && k.endValue <= this.viewportMinimum || k.startValue >= this.viewportMaximum && k.endValue >= this.viewportMaximum || s(k.startValue) || s(k.endValue) || isNaN(this.range)) || l.push(k))
                }
                ...
                if (!g) {
                    ...
                    this.ctx.clip();
                    for (b = 0; b < l.length; b++) k =
                        l[b], k.showOnTop ? f || (f = !0, this.chart.addEventListener("dataAnimationIterationEnd", function() {
                            this.ctx.save();
                            this.ctx.beginPath();
                            this.ctx.rect(this.chart.plotArea.x1, this.chart.plotArea.y1, this.chart.plotArea.width, this.chart.plotArea.height);
                            this.ctx.clip();
                    ...
                    for (b = 0; b < w.length; b++) c = w[b], c.stripLine.showOnTop ? g || (g = !0, this.chart.addEventListener("dataAnimationIterationEnd", function() {
                ...
                if (g)
                    for (g = !1, b = 0; b < w.length; b++) c = w[b], "outside" === c.stripLine.labelPlacement && c.textBlock.render(!0)
            }
        };
            ...
            if ("bottom" === this._position || "top" === this._position) {
                if (this.lineThickness) {
                    ...
                    if (this.scaleBreaks && !s(this.scaleBreaks.firstBreakIndex))
                        if (s(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + b;
                            ...
                            for (var l = this.scaleBreaks.firstBreakIndex; l <= this.scaleBreaks.lastBreakIndex; l++) d.moveTo(e,
                                g), d.lineTo(this.scaleBreaks._appliedBreaks[l].startPixel + c, g), e = this.scaleBreaks._appliedBreaks[l].endPixel + b;
                ...
                if (this.scaleBreaks && !s(this.scaleBreaks.firstBreakIndex))
                    if (s(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + c;
                        ...
                        for (l = this.scaleBreaks.firstBreakIndex; l <= this.scaleBreaks.lastBreakIndex; l++) d.moveTo(g, e), d.lineTo(g, this.scaleBreaks._appliedBreaks[l].startPixel + b), e = this.scaleBreaks._appliedBreaks[l].endPixel + c;
        ...
        E.prototype.calculateAxisParameters = function() {
            if (this.logarithmic) this.calculateLogarithmicAxisParameters();
                ...
                if ("axisX" === this.type) {
                    ...
                    Infinity !== this.dataInfo.minDiff ? g = this.dataInfo.minDiff : 1 < f - e ? g = 0.5 * Math.abs(f - e) : (g = 1, c && (d = !0))
                    ...
                    isFinite(f) ? isFinite(e) ? isFinite(f) || (f = e) : e = f : (f = "undefined" === typeof this.options.interval ? -Infinity : this.options.interval, e = "undefined" !== typeof this.options.interval || isFinite(this.dataInfo.minDiff) ? 0 : Infinity), 0 === e && 0 === f ? (f += 9, e = 0) : 0 === f - e ? (b = Math.min(Math.abs(0.01 * Math.abs(f)), 5), f += b, e -= b) : e > f ? (b = Math.min(0.01 * Math.abs(this.getApparentDifference(f, e, null, !0)), 5), 0 <= f ? e = f - b : f = isFinite(e) ? e + b : 0) : (b = Math.min(0.01 * Math.abs(this.getApparentDifference(e, f, null, !0)), 0.05), 0 !== f && (f += b), 0 !== e && (e -=
                        b)), g = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < f - e ? 0.5 * Math.abs(f - e) : 1, this.includeZero && (null === this.viewportMinimum || isNaN(this.viewportMinimum)) && 0 < e && (e = 0), this.includeZero && (null === this.viewportMaximum || isNaN(this.viewportMaximum)) && 0 > f && (f = 0));
                ...
                if ("axisX" === this.type && c) {
                    ...
                    if (null === this.viewportMaximum || isNaN(this.viewportMaximum)) this.viewportMaximum = "axisX" === this.type ? f + g / 2 :
                ...
                if (null === this.minimum || null === this.maximum)
                    if ("axisX" === this.type ? (e = null !== this.minimum ? this.minimum : this.dataInfo.min, f = null !== this.maximum ?
                        ...
                        if (null === this.minimum || isNaN(this.minimum)) this.minimum = e - g / 2, this.minimum = Math.min(this.minimum, null === this.sessionVariables.viewportMinimum || isNaN(this.sessionVariables.viewportMinimum) ? Infinity : this.sessionVariables.viewportMinimum);
                        if (null === this.maximum || isNaN(this.maximum)) this.maximum = f + g / 2, this.maximum = Math.max(this.maximum, null === this.sessionVariables.viewportMaximum ||
        ...
        E.prototype.calculateLogarithmicAxisParameters = function() {
            ...
            if (this.scaleBreaks)
                for (g =
                    0; g < this.scaleBreaks._appliedBreaks.length; g++)
                    if ((!s(this.sessionVariables.newViewportMinimum) && this.sessionVariables.newViewportMinimum >= this.scaleBreaks._appliedBreaks[g].startValue || !s(this.options.minimum) && this.options.minimum >= this.scaleBreaks._appliedBreaks[g].startValue || !s(this.options.viewportMinimum) && this.viewportMinimum >= this.scaleBreaks._appliedBreaks[g].startValue) && (!s(this.sessionVariables.newViewportMaximum) && this.sessionVariables.newViewportMaximum <= this.scaleBreaks._appliedBreaks[g].endValue ||
                            !s(this.options.maximum) && this.options.maximum <= this.scaleBreaks._appliedBreaks[g].endValue || !s(this.options.viewportMaximum) && this.viewportMaximum <= this.scaleBreaks._appliedBreaks[g].endValue)) { this.scaleBreaks._appliedBreaks.splice(g, 1); break }
                    "axisX" === this.type ? (b = null !== this.viewportMinimum ? this.viewportMinimum : this.dataInfo.viewPortMin, e = null !== this.viewportMaximum ? this.viewportMaximum : this.dataInfo.viewPortMax, 1 === e / b && (g = Math.pow(this.logarithmBase, "undefined" === typeof this.options.interval ?
            ...
            g = (isNaN(this.viewportMaximum) || null === this.viewportMaximum ? e : this.viewportMaximum) / (isNaN(this.viewportMinimum) || null === this.viewportMinimum ? b : this.viewportMinimum);
            ...
            this.options && 0 < this.options.interval ? this.interval = this.options.interval : (this.interval = E.getNiceExponent(Math.log(g) / d / (a - 1), !0), c = E.getNiceNumber(l / (a - 1), !0));
            ...
            if (null === this.minimum || null === this.maximum) "axisX" === this.type ? (b = null !== this.minimum ? this.minimum : this.dataInfo.min, e = null !== this.maximum ? this.maximum : this.dataInfo.max, 1 === e / b && (g = Math.pow(this.logarithmBase, "undefined" === typeof this.options.interval ? 0.4 : this.options.interval), e *= g, b /= g), f = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : e / b > this.logarithmBase ? e / b * Math.pow(this.logarithmBase, 0.5) : this.logarithmBase) : "axisY" === this.type && (b = null !== this.minimum ?
            ...
            if (!this.valueFormatString && (this.valueFormatString = "#,##0.##", 1 > this.viewportMinimum)) {
                ...
                if (2 < d)
                    for (g = 0; g < d - 2; g++) this.valueFormatString += "#"
            }
        };
        ...
        T.prototype.render = function(a) {
            if (0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
                ...
                if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
                    if (b = 1 === n % 2 ? (b.x << 0) + 0.5 : b.x << 0, g = 1 === n % 2 ? (e.x << 0) + 0.5 : e.x << 0, "top" === this.scaleBreaks.parent._position ? (e = this.chart.plotArea.y1, l = this.chart.plotArea.y2 + n / 2 + 0.5 << 0) : (e = this.chart.plotArea.y2, l = this.chart.plotArea.y1 - n / 2 + 0.5 << 0, a *= -1), this.bounds = { x1: b - n / 2, y1: e, x2: g + n / 2, y2: l }, this.ctx.moveTo(b,
                            e), "straight" === this.type || "top" === this.scaleBreaks.parent._position && 0 >= a || "bottom" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(b, l), this.ctx.lineTo(g, l), this.ctx.lineTo(g, e);
                    ...
                    if (e = 1 === n % 2 ? (e.y << 0) + 0.5 : e.y << 0, l = 1 === n % 2 ? (b.y << 0) + 0.5 : b.y << 0, "left" === this.scaleBreaks.parent._position ? (b = this.chart.plotArea.x1, g = this.chart.plotArea.x2 + n / 2 + 0.5 << 0) : (b = this.chart.plotArea.x2,
                            g = this.chart.plotArea.x1 - n / 2 + 0.5 << 0, a *= -1), this.bounds = { x1: b, y1: e - n / 2, x2: g, y2: l + n / 2 }, this.ctx.moveTo(b, e), "straight" === this.type || "left" === this.scaleBreaks.parent._position && 0 >= a || "right" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(g, e), this.ctx.lineTo(g, l), this.ctx.lineTo(b, l);
                    else if ("wavy" === this.type) {
                    s = b;
                    k = e;
                    f = 0.5;
        ...
        M.prototype.render = function() {
            ...
            if (0 < d) {
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position) e = f = 1 ===
                    this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, g = this.chart.plotArea.y1, l = this.chart.plotArea.y2, this.bounds = { x1: e - d / 2, y1: g, x2: f + d / 2, y2: l };
                else if ("left" === this.parent._position || "right" === this.parent._position) g = l = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0, e = this.chart.plotArea.x1, f = this.chart.plotArea.x2, this.bounds = { x1: e, y1: g - d / 2, x2: f, y2: l + d / 2 };
                this.ctx.moveTo(e, g);
                this.ctx.lineTo(f, l);
                this.ctx.stroke();
        ...
        $.prototype.render = function(a, d, c) {
            ...
            if (!this.valueFormatString)
                if ("dateTime" === this.parent.valueType) this.valueFormatString = this.parent.valueFormatString;
                    ...
                    var n = 0,
                        n = "xySwapped" === this.chart.plotInfo.axisPlacement ? 50 < this.parent.range ? 0 : 500 < this.chart.width && 25 > this.parent.range ? 2 : Math.floor(Math.abs(Math.log(this.parent.range) / Math.LN10)) + (5 > this.parent.range ? 2 : 10 > this.parent.range ? 1 : 0) : 50 < this.parent.range ? 0 : Math.floor(Math.abs(Math.log(this.parent.range) /
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    for (var y = 0; y < this.parent.dataSeries.length; y++)(v = this.parent.dataSeries[y].getDataPointAtX(r, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[y], null !== v.dataPoint.y && v.dataSeries.visible && m.push(v));
                    v = null;
                    ...
                    if ("rangeBar" === m[0].dataSeries.type || "error" ===
                        ...
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), A = u = 0, r = y = 0; r <
                            m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                        ...
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), C = A = u = 0, r = 0; r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                                for (x = 0; x < m[r].dataPoint.y.length; x++) u = Math.abs(a -
                                    this.parent.convertValueToPixel(m[r].dataPoint.y[x])), u < v && (v = u, y = r);
                            else A += m[r].dataPoint.y, C = m[r].dataPoint.x.getTime ? m[r].dataPoint.x.getTime() : m[r].dataPoint.x, C = 100 * (A / m[r].dataSeries.plotUnit.dataPointYSums[C]), u = Math.abs(a - this.parent.convertValueToPixel(C)), u < v && (v = u, y = r);
                    else
                        for (v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), r = y = u = 0; r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                                for (x = 0; x < m[r].dataPoint.y.length; x++) u = Math.abs(a - this.parent.convertValueToPixel(m[r].dataPoint.y[x])),
                                    u < v && (v = u, y = r);
                            else u = Math.abs(a - this.parent.convertValueToPixel(m[r].dataPoint.y)), u < v && (v = u, y = r);
                    x = m[y];
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if ("rangeBar" === this.parent.dataSeries[y].type || "error" === this.parent.dataSeries[y].type) {
                            ...
                            l = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataPoint.y[b]) <<
                                0) + 0.5 : this.parent.convertValueToPixel(x.dataPoint.y[b]) << 0;
                            this.value = x.dataPoint.y[b];
                            k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: x.dataPoint.y[b] }) : s(this.options.label) ? ea(c ? c : x.dataPoint.y[b], this.valueFormatString, this.chart._cultureInfo) : this.label
                        } else if ("stackedBar" === this.parent.dataSeries[y].type) {
                            v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y));
                            A = u = 0;
                            for (r = y; 0 <= r; r--) A += m[r].dataPoint.y, u = Math.abs(a -
                                this.parent.convertValueToPixel(A)), u < v && (v = u, b = r);
                            l = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(A) << 0) + 0.5 : this.parent.convertValueToPixel(A) << 0;
                            this.value = A;
                            k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: x.dataPoint.y }) : s(this.options.label) ? ea(c ? c : x.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label
                        } else if ("stackedBar100" === this.parent.dataSeries[y].type) {
                            v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y));
                            C = A = u = 0;
                            for (r = y; 0 <= r; r--) A += m[r].dataPoint.y, C = m[r].dataPoint.x.getTime ? m[r].dataPoint.x.getTime() : m[r].dataPoint.x, C = 100 * (A / m[r].dataSeries.plotUnit.dataPointYSums[C]), u = Math.abs(a - this.parent.convertValueToPixel(C)), u < v && (v = u, b = r);
                            l = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(C) << 0) + 0.5 : this.parent.convertValueToPixel(C) << 0;
                            this.value = C;
                            k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: C }) : s(this.options.label) ? ea(c ? c : C,
                                this.valueFormatString, this.chart._cultureInfo) : this.label
                        } else l = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataPoint.y) << 0) + 0.5 : this.parent.convertValueToPixel(x.dataPoint.y) << 0, this.value = x.dataPoint.y, k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: x.dataPoint.y }) : s(this.options.label) ? ea(c ? c : x.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label;
                        b = e = l;
                        ...
                        f =
                            g = w = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataPoint.x) << 0) + 0.5 : this.parent.convertValueToPixel(x.dataPoint.x) << 0;
                        ...
                        if (C) {
                            if ("axisX" === this.parent.type)
                                for (r = this.parent.convertPixelToValue({ y: d }), v = null, y = 0; y < this.parent.dataSeries.length; y++)(v =
                            ...
                            this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: x.dataPoint.x }) : s(this.options.label) ? ea(x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label);
                    ...
                    for (y = 0; y < this.parent.dataSeries.length; y++)(v = this.parent.dataSeries[y].getDataPointAtX(r, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[y], null !== v.dataPoint.y && v.dataSeries.visible &&
                        m.push(v));
                    if (0 === m.length) return;
                    m.sort(function(a, b) { return a.distance - b.distance });
                    x = m[0];
                    ...
                    if (C) {
                        ...
                        s(this.options.label) ? Aa(x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: x.dataPoint.x }) : s(this.options.label) ? ea(x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label);
                    this.value = x.dataPoint.x;
                    k.x = b - k.measureText().width / 2;
                    ...
                    for (y = 0; y < this.parent.dataSeries.length; y++)(v = this.parent.dataSeries[y].getDataPointAtX(r, !0)) && 0 <= v.index &&
                        (v.dataSeries = this.parent.dataSeries[y], null !== v.dataPoint.y && v.dataSeries.visible && m.push(v));
                    if (0 === m.length) return;
                    m.sort(function(a, b) { return a.distance - b.distance });
                    y = 0;
                    if ("rangeColumn" === m[0].dataSeries.type || "rangeArea" === m[0].dataSeries.type || "error" === m[0].dataSeries.type || "rangeSplineArea" === m[0].dataSeries.type || "candlestick" === m[0].dataSeries.type || "ohlc" === m[0].dataSeries.type || "boxAndWhisker" === m[0].dataSeries.type)
                        ...
                        for (v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y)), r = A = u = 0; r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                                for (x = 0; x <
                                    m[r].dataPoint.y.length; x++) u = Math.abs(d - this.parent.convertValueToPixel(m[r].dataPoint.y[x])), u < v && (v = u, y = r);
                        ...
                        for (v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y)), r = C = A = u = 0; r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                                for (x = 0; x < m[r].dataPoint.y.length; x++) u = Math.abs(d - this.parent.convertValueToPixel(m[r].dataPoint.y[x])),
                                    u < v && (v = u, y = r);
                            else A += m[r].dataPoint.y, C = m[r].dataPoint.x.getTime ? m[r].dataPoint.x.getTime() : m[r].dataPoint.x, C = 100 * (A / m[r].dataSeries.plotUnit.dataPointYSums[C]), u = Math.abs(d - this.parent.convertValueToPixel(C)), u < v && (v = u, y = r);
                    else
                        for (v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y)), r = u = 0; r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                                for (x = 0; x < m[r].dataPoint.y.length; x++) u = Math.abs(d - this.parent.convertValueToPixel(m[r].dataPoint.y[x])), u < v && (v = u, y = r);
                            else u = Math.abs(d -
                                this.parent.convertValueToPixel(m[r].dataPoint.y)), u < v && (v = u, y = r);
                    x = m[y];
                    b = 0;
                    if ("rangeColumn" === this.parent.dataSeries[y].type || "rangeArea" === this.parent.dataSeries[y].type || "error" === this.parent.dataSeries[y].type || "rangeSplineArea" === this.parent.dataSeries[y].type || "candlestick" === this.parent.dataSeries[y].type || "ohlc" === this.parent.dataSeries[y].type || "boxAndWhisker" === this.parent.dataSeries[y].type) {
                        ...
                        for (r = u = 0; r < x.dataPoint.y.length; r++) u =
                            Math.abs(d - this.parent.convertValueToPixel(x.dataPoint.y[r])), u < v && (v = u, b = r);
                        ...
                        k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: x.dataPoint.y }) : s(this.options.label) ?
                        ...
                        v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y));
                        A = u = 0;
                        for (r = y; 0 <= r; r--) A += m[r].dataPoint.y, C = m[r].dataPoint.x.getTime ? m[r].dataPoint.x.getTime() : m[r].dataPoint.x, C = 100 * (A / m[r].dataSeries.plotUnit.dataPointYSums[C]), u = Math.abs(d - this.parent.convertValueToPixel(C)), u < v && (v = u, b = r);
                        w =
                            1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(C) << 0) + 0.5 : this.parent.convertValueToPixel(C) << 0;
                        k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: C }) : s(this.options.label) ? ea(c ? c : C, this.valueFormatString, this.chart._cultureInfo) : this.label;
                        this.value = C
                        ...
                        0, k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : x.dataPoint.y }) : s(this.options.label) ? ea(c ? c : x.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = x.dataPoint.y);
                    f = g = w;
                    b = this.chart.plotArea.x1;
                    e = this.chart.plotArea.x2;
                    this.bounds = { x1: b, y1: f - n / 2, x2: e, y2: g + n / 2 };
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position) b = e = l = 1 === q.lineWidth % 2 ? (a << 0) + 0.5 : a << 0, f = this.chart.plotArea.y1, g = this.chart.plotArea.y2, this.bounds = { x1: b - n / 2, y1: f, x2: e + n / 2, y2: g };
                else if ("left" === this.parent._position || "right" === this.parent._position) f = g = w = 1 === q.lineWidth % 2 ? (d << 0) + 0.5 : d << 0, b = this.chart.plotArea.x1, e = this.chart.plotArea.x2,
                    this.bounds = { x1: b, y1: f - n / 2, x2: e, y2: g + n / 2 };
                if ("xySwapped" === this.chart.plotInfo.axisPlacement)
                    if ("left" === this.parent._position || "right" === this.parent._position) {
                        ...
                        if (C) {
                            if ("axisX" === this.parent.type)
                                for (r = this.parent.convertPixelToValue({ y: d }), v = null, y = 0; y < this.parent.dataSeries.length; y++)(v = this.parent.dataSeries[y].getDataPointAtX(r, !0)) && 0 <= v.index &&
                ...
                0 < n && (q.moveTo(b, f), q.lineTo(e, g), q.stroke(), this._hidden = !1);
                q.restore();
            ...
            if ("bottom" === this.parent._position ||
                "top" === this.parent._position) this._updatedValue = this.parent.convertPixelToValue(l);
            ...
            if (!this.chart.disableToolTip) {
                ...
                if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                    if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                        ...
                        if (this.chart.axisX)
                            for (var v = 0; v < this.chart.axisX.length; v++) {
                                for (var g = this.chart.axisX[v].convertPixelToValue({ y: d }), k =
                                        null, b = 0; b < this.chart.axisX[v].dataSeries.length; b++)(k = this.chart.axisX[v].dataSeries[b].getDataPointAtX(g, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX[v].dataSeries[b], null !== k.dataPoint.y && l.push(k));
                                k = null
                            }
                        if (this.chart.axisX2)
                            for (v = 0; v < this.chart.axisX2.length; v++) {
                                ...
                                k = null;
                                for (b = 0; b < this.chart.axisX2[v].dataSeries.length; b++)(k = this.chart.axisX2[v].dataSeries[b].getDataPointAtX(g, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX2[v].dataSeries[b],
                        ...
                        if (this.chart.axisX)
                            for (v = 0; v < this.chart.axisX.length; v++)
                                for (g = this.chart.axisX[v].convertPixelToValue({ x: a }), k = null, b = 0; b < this.chart.axisX[v].dataSeries.length; b++)(k = this.chart.axisX[v].dataSeries[b].getDataPointAtX(g, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX[v].dataSeries[b], null !== k.dataPoint.y && l.push(k));
                        if (this.chart.axisX2)
                            for (v = 0; v < this.chart.axisX2.length; v++)
                                for (g = this.chart.axisX2[v].convertPixelToValue({ x: a }), k = null, b = 0; b < this.chart.axisX2[v].dataSeries.length; b++)(k =
                    ...
                    if (k = this.chart.getDataPointAtXY(a, d, c)) this.currentDataPointIndex = k.dataPointIndex, this.currentSeriesIndex = k.dataSeries.index;
                        ...
                        if (k = Ya(a, d, this.chart._eventManager.ghostCtx),
                            0 < k && "undefined" !== typeof this.chart._eventManager.objectMap[k]) {
                    ...
                    if (0 <= this.currentSeriesIndex) {
                        ...
                        if (0 <= this.currentDataPointIndex) b = e.dataPoints[this.currentDataPointIndex], k.dataSeries = e, k.dataPoint =
                            b, k.index = this.currentDataPointIndex, k.distance = Math.abs(b.x - g), "waterfall" === e.type && (k.cumulativeSumYStartValue = e.dataPointEOs[this.currentDataPointIndex].cumulativeSumYStartValue, k.cumulativeSum = e.dataPointEOs[this.currentDataPointIndex].cumulativeSum);
                        else {
                    ...
                    if (this.highlightObjects(f), this.enabled) {
                        ...
                        if (null !== c) {
                            ...
                            "pie" === f[0].dataSeries.type || "doughnut" === f[0].dataSeries.type || "funnel" === f[0].dataSeries.type || "pyramid" === f[0].dataSeries.type ||
                                "bar" === f[0].dataSeries.type || "rangeBar" === f[0].dataSeries.type || "stackedBar" === f[0].dataSeries.type || "stackedBar100" === f[0].dataSeries.type ? a = a - 10 - this.container.clientWidth : (a = f[0].dataSeries.axisX.convertValueToPixel(f[0].dataPoint.x) - this.container.clientWidth << 0, a -= 10);
        ...
        W.prototype.getToolTipInnerHTML = function(a) {
            a = a.entries;
            for (var d = null, c = null, b = null, e = 0, f = "", g = !0, l = 0; l < a.length; l++)
                if (a[l].dataSeries.toolTipContent ||
                    a[l].dataPoint.toolTipContent) { g = !1; break }
        ...
        W.prototype.showAtX = function(a, d) {
            ...
            if (this.shared)
                for (var g = 0; g < this.chart.data.length; g++) c = this.chart.data[g], (b = c.getDataPointAtX(a, !1)) && (b.dataPoint && !s(b.dataPoint.y) && c.visible) && (b.dataSeries = c, f.push(b));
            else c = this.chart.data[d], (b = c.getDataPointAtX(a, !1)) && (b.dataPoint && !s(b.dataPoint.y) && c.visible) && (b.dataSeries = c, f.push(b));
            if (0 < f.length) {
                for (g = 0; g < f.length; g++)
                    if (b = f[g], b.dataPoint.x < b.dataSeries.axisX.viewportMinimum ||
            ...
            if ("mousemove" === a.type || "click" === a.type) {
                ...
                if ((b = this.chart.getObjectAtXY(c.x, c.y, !1)) && "undefined" !== typeof this.objectMap[b])
                    if (b = this.objectMap[b], "dataPoint" === b.objectType) {
                        ...
                        b.eventParameter = { x: c.x, y: c.y, dataPoint: f, dataSeries: e.options, dataPointIndex: g, dataSeriesIndex: e.index, chart: this.chart };
