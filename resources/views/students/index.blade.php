    ...
    <!-- Small table -->
        <div class="col-md-12 my-4">
            <div class="d-flex mb-4">
                ...
                <a href="{{ route('students.create') }}" class="btn btn-primary ml-auto">إضافة طلاب</a>
            </div>
                ...
                <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <td>
                            ...
                            <a class="dropdown-item text-left delete-with-modal" href="javascript:void()" data-href="{{ route('archive.archive', $student->id)}}" data-toggle="modal" data-message="هل انت متاكد؟" data-target="#deleteModal">ارشفة</a>
                            <a class="dropdown-item text-left delete-with-modal" href="javascript:void()" data-href="{{ route('students.destroy', $student->id)}}" data-toggle="modal" data-message="هل انت متاكد من الحذف سوف تفقد كل بيانات الطالب؟" data-target="#deleteModal">حذف</a>
                            </div>
                        </td>
                        </tr>
                        @endforeach
