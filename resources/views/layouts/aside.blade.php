      ...
      <ul class="navbar-nav flex-fill w-100 mb-2">
        ...
        <li class="nav-item dropdown">
            ...
            <ul class="collapse list-unstyled pl-4 w-100" id="queries">
              ...
              <li class="nav-item">
                  <a class="nav-link pl-3 general-modal" data-href="{{ route('supplements.check.list') }}" data-title="عرض قوائم الدرجات"  data-toggle="modal" data-target="#generalListModal" data-varyModalLabel="pjpojop" href="javascript:void();"><span class="ml-1 item-text">عرض قوائم الدرجات</span>
                  </a>
              </li>
              <li class="nav-item">
                <a class="nav-link pl-3 general-modal" data-href="{{ route('supplements.list') }}" data-title="القوائم للملاحق والبدائل" data-toggle="modal" data-target="#generalListModal" href="javascript:void();"><span class="ml-1 item-text">القوائم للملاحق والبدائل</span>
                </a>
            </li>
            <li class="nav-item">
