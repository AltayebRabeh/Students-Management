...
<div class="row">
    ...
    <div class="col-md-12 my-4">
        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('supplements.store')); ?>" method="POST" id="grades">
                    <?php echo csrf_field(); ?>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#btn-send').click(function (event) {
            ...
            $.ajax({
                type: "POST",
                url : "<?php echo e(route('supplements.store')); ?>",
                data : $('form#grades').serialize(),

                success  : function(data) {
                    if(data) {
                        window.location.assign("<?php echo e(route('supplements.index')); ?>");
                    }
                },
                error: function(data) {
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Altayeb (Don't tuch)\Students-Management\resources\views/supplements/create.blade.php ENDPATH**/ ?>