                                        ...
                                        <?php if($loop->last): ?>
                                            <tr>
                                                <th class="d-flex justify-content-between"  style="text-align:center;padding-top: 10px;padding-bottom: 20px;border-bottom: 2px solid;">
                                                    ...
                                                    <?php if(number_format(array_sum($year_total) != 0 ? array_sum($year_total) / array_sum($year_hours) : 00, 2) < $cgp_success || ($equations_fails > 0 && $equations_fails <= $fails)): ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/altayeb/Desktop/university/resources/views/student_grades/result.blade.php ENDPATH**/ ?>