...
<div class="row">
    ...
    <div class="col-md-12 my-4">
        <div class="mb-4">
            <h2 class="h4">عرض نتيجة فصل دراسي </h2>
        </div>
        <div class="card shadow">
            <div class="card-body">
                <form action="<?php echo e(route('student-grades.semester-result')); ?>" id="studentSemesterData" method="GET">
                    <div class="form-row">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Altayeb (Don't tuch)\Students-Management\resources\views/student_grades/semester-data.blade.php ENDPATH**/ ?>