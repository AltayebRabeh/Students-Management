...
<div class="row">
    ...
    <div class="col-md-12 my-4">
        <div class="mb-4">
            <h2 class="h4">حذف نتيجة مادة لفصل</h2>
        </div>
        <div class="card shadow">
            <div class="card-body">
                <form action="<?php echo e(route('grades.destroy')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-1 mb-3 pt-1">
                            <a class="btn btn-danger mt-4" data-toggle="modal" data-target="#deleteGradeModal" href="javascript:void();">حذف</a>
                            <?php echo $__env->make('layouts.modals.delete-grades-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                    </div>
                </form>
            </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Altayeb (Don't tuch)\Students-Management\resources\views/grades/delete.blade.php ENDPATH**/ ?>