        ...
        <div class="card shadow">
          <div class="card-body px-1" id="printDocument">
                <div class="col-12 text-center mb-4">
                    ...
                    <p class="text-muted"><strong>الصف</strong> (<?php echo e($classroom); ?>)
                        <?php if($semesrer): ?>
                            <strong>الفصل</strong> (<?php echo e($semesrer); ?>)
                        <?php endif; ?>
                    </p>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Altayeb (Don't tuch)\Students-Management\resources\views/supplements/list.blade.php ENDPATH**/ ?>