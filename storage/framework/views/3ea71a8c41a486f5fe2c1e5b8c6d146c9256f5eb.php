...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="<?php echo e(asset('uploads/'.cache('settings')['logo'])); ?>">
    <title><?php echo e(cache('settings')['university_name']); ?> <?php echo $__env->yieldContent('title'); ?></title>
