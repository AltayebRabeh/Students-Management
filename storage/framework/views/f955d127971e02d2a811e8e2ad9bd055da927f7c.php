<aside class="sidebar-left border-right bg-white shadow" id="leftSidebar" data-simplebar>
    ...
    <nav class="vertnav navbar navbar-light">
      ...
      <ul class="navbar-nav flex-fill w-100 mb-2">
        ...
        <?php if (app('laratrust')->ability('admin', 'show-students|show-students|create-students|show-students-archive')) : ?>
            <li class="nav-item dropdown">
                ...
                <ul class="collapse list-unstyled pl-4 w-100" id="Students">
                    <?php if (app('laratrust')->ability('admin', 'show-students')) : ?>
                    <li class="nav-item">
                    ...
                    <?php if (app('laratrust')->ability('admin', 'create-students')) : ?>
                    <li class="nav-item">
                        <a class="nav-link pl-3" href="<?php echo e(route('students.create')); ?>"><span class="ml-1 item-text">إضافة طلاب</span></a>
                    </li>
                    <?php endif; // app('laratrust')->ability ?>
                    <?php if (app('laratrust')->ability('admin', 'show-students-archive')) : ?>
                    <li class="nav-item">
        ...
        <?php endif; // app('laratrust')->ability ?>
        <?php if (app('laratrust')->ability('admin', 'print-student-grades|print-students-list|print-student-semester-grades|print-check-list|print-supplements|print-supplements-list|print-semester-grades|print-grades-statistics')) : ?>
        <li class="nav-item dropdown">
            ...
            <?php if (app('laratrust')->ability('admin', 'print-students-list')) : ?>
                    <li class="nav-item">
            ...
            <?php endif; // app('laratrust')->ability ?>
            <?php if (app('laratrust')->ability('admin', 'print-check-list')) : ?>
                <li class="nav-item">
            ...
            <?php endif; // app('laratrust')->ability ?>
            <?php if (app('laratrust')->ability('admin', 'print-supplements-list')) : ?>
                <li class="nav-item">
            ...
            <?php endif; // app('laratrust')->ability ?>
            <?php if (app('laratrust')->ability('admin', 'print-student-semester-grades')) : ?>
                <li class="nav-item">
                    <a class="nav-link pl-3" href="<?php echo e(route('student-grades.semester-data')); ?>"><span class="ml-1 item-text">طباعة فصل لطالب</span>
                    </a>
                </li>
            <?php endif; // app('laratrust')->ability ?>
            <?php if (app('laratrust')->ability('admin', 'print-grades-statistics')) : ?>
                <li class="nav-item">
        ...
        <?php endif; // app('laratrust')->ability ?>
        <?php if (app('laratrust')->ability('admin', 'create-semester-grades|edit-semester-grades|delete-semester-grades|create-supplements|create-student-grades|delete-student-grades')) : ?>
        <li class="nav-item dropdown">
        ...
        <?php endif; // app('laratrust')->ability ?>
        <?php if (app('laratrust')->ability('admin', 'show-sections|create-sections')) : ?>
        <li class="nav-item dropdown">
        ...
        <?php endif; // app('laratrust')->ability ?>
        <?php if (app('laratrust')->ability('admin', 'show-subjects|create-subjects')) : ?>
        <li class="nav-item dropdown">
        ...
        <?php endif; // app('laratrust')->ability ?>
        <?php if (app('laratrust')->ability('admin', 'show-teachers|create-teachers')) : ?>
        <li class="nav-item dropdown">
        ...
        <?php endif; // app('laratrust')->ability ?>
        <?php if (app('laratrust')->ability('admin', 'show-subjects-teachers|create-subjects-teachers')) : ?>
        <li class="nav-item dropdown">
            ...
            <ul class="collapse list-unstyled pl-4 w-100" id="subjectsTeachers">
                <?php if (app('laratrust')->ability('admin', 'show-subjects-teachers')) : ?>
                    <li class="nav-item">
                        <a class="nav-link pl-3" href="<?php echo e(route('subjects-teachers.index')); ?>"><span class="ml-1 item-text"> عرض</span>
                        </a>
                    </li>
              <?php endif; // app('laratrust')->ability ?>
              <?php if (app('laratrust')->ability('admin', 'create-subjects-teachers')) : ?>
                <li class="nav-item">
        ...
        <?php endif; // app('laratrust')->ability ?>
        <?php if (app('laratrust')->ability('admin', 'show-equations|create-equations')) : ?>
        <li class="nav-item dropdown">
            ...
            <ul class="collapse list-unstyled pl-4 w-100" id="equations">
                <?php if (app('laratrust')->ability('admin', 'show-equations')) : ?>
                    <li class="nav-item">
                        <a class="nav-link pl-3" href="<?php echo e(route('equations.index')); ?>"><span class="ml-1 item-text">عرض الكل</span>
                        </a>
                    </li>
                <?php endif; // app('laratrust')->ability ?>
                <?php if (app('laratrust')->ability('admin', 'create-equations')) : ?>
                    <li class="nav-item">
        ...
        <?php endif; // app('laratrust')->ability ?>
        <?php if (app('laratrust')->ability('admin', 'show-marks|create-marks')) : ?>
        <li class="nav-item dropdown">
        ...
        <?php endif; // app('laratrust')->ability ?>
        <?php if (app('laratrust')->ability('admin', 'show-years|create-years')) : ?>
        <li class="nav-item dropdown">
        ...
        <?php endif; // app('laratrust')->ability ?>
        <?php if (app('laratrust')->ability('admin', 'show-relays|create-relays')) : ?>
        <li class="nav-item dropdown">
        ...
        <?php endif; // app('laratrust')->ability ?>
        <?php if (app('laratrust')->ability('admin', 'show-users|create-users')) : ?>
        <li class="nav-item dropdown">
        ...
        <?php endif; // app('laratrust')->ability ?>
        <?php if (app('laratrust')->ability('admin', 'activity-log')) : ?>
        <li class="nav-item">
...
<?php /**PATH E:\Altayeb (Don't tuch)\Students-Management\resources\views/layouts/aside.blade.php ENDPATH**/ ?>