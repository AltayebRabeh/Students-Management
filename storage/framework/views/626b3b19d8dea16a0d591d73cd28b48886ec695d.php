        ...
        $(document).ready(function() {
            ...
            $('select[name="year_id"], select[name="classroom_id"], select[name="section_id"], select[name="semester_id"]').on('change', function() {
                ...
                if (year_id && section_id && classroom_id && semester_id) {
                    $.ajax({
                        url: "<?php echo e(URL::to('get-subject-for-grades-ajax')); ?>/" + section_id + "/" + classroom_id + "/" + semester_id + "/" + year_id,
                        type: "GET",
                        dataType: "json",
...
<?php /**PATH E:\Altayeb (Don't tuch)\Students-Management\resources\views/layouts/extends/ajax-get-subject-teacher.blade.php ENDPATH**/ ?>