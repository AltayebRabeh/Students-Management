...
<div class="row">
    ...
    <div class="col-md-12 my-4">
        ...
        <div class="card shadow">
            <div class="card-body">
                <form action="<?php echo e(route('student-grades.semester-result')); ?>" method="GET">
                    <div class="form-row">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/altayeb/Desktop/university/resources/views/student_grades/semester-data.blade.php ENDPATH**/ ?>