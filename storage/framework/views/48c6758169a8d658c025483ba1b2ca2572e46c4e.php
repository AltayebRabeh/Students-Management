...
<?php $component->withAttributes([]); ?>
     ...
     <?php $__env->slot('content', null, []); ?> 
        ...
        <div class="mt-3 max-w-xl text-sm text-gray-600">
            <p>
                <?php echo e(__('عند تمكين المصادقة الثنائية ، ستتم مطالبتك برمز مميز آمن وعشوائي أثناء المصادقة. يمكنك استرداد هذا الرمز المميز من تطبيق Google Authenticator بهاتفك.')); ?>
        ...
        <?php if($this->enabled): ?>
            <?php if($showingQrCode): ?>
                <div class="mt-4 max-w-xl text-sm text-gray-600">
                    <p class="font-semibold">
                        <?php echo e(__('تم تمكين المصادقة الثنائية الآن. امسح رمز الاستجابة السريعة التالي ضوئيًا باستخدام تطبيق المصادقة على هاتفك.')); ?>
            ...
            <?php if($showingRecoveryCodes): ?>
                <div class="mt-4 max-w-xl text-sm text-gray-600">
                    <p class="font-semibold">
                        <?php echo e(__('قم بتخزين رموز الاسترداد هذه في مدير كلمات مرور آمن. يمكن استخدامها لاستعادة الوصول إلى حسابك في حالة فقد جهاز المصادقة الثنائية الخاص بك.')); ?>
...
<?php $component->withAttributes(['class' => 'mr-3']); ?>
                            <?php echo e(__('إعادة إنشاء رموز الاسترداد')); ?>
...
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['class' => 'mr-3']); ?>
                            <?php echo e(__('إظهار رموز الاسترداد')); ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH E:\Altayeb (Don't tuch)\Students-Management\resources\views/profile/two-factor-authentication-form.blade.php ENDPATH**/ ?>