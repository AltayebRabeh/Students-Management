...
<div class="modal fade" id="supplementListModal" tabindex="-1" role="dialog" aria-labelledby="varyModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="<?php echo e(route('supplements.list')); ?>" method="GET">
...
</div><?php /**PATH /home/altayeb/Desktop/university/resources/views/layouts/modals/supplements-list-modal.blade.php ENDPATH**/ ?>