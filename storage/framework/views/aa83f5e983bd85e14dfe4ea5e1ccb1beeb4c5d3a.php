    ...
    <div class="wrapper vh-100">
      <div class="align-items-center h-100 d-flex w-50 mx-auto">
        <div class="mx-auto text-center">
          ...
          <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-lg btn-primary px-5">Back to Dashboard</a>
        </div>
      </div>
    </div>
  </body>
...
</html><?php /**PATH /home/altayeb/Desktop/university/resources/views/errors/404.blade.php ENDPATH**/ ?>