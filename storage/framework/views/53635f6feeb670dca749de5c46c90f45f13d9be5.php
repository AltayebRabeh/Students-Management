    ...
    <!-- Small table -->
        <div class="col-md-12 my-4">
            <div class="d-flex mb-4">
                ...
                <a href="<?php echo e(route('subjects-teachers.create')); ?>" id="subjectsTeachers" class="btn btn-primary ml-auto">دمج</a>
            </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Altayeb (Don't tuch)\Students-Management\resources\views/subjects_teachers/index.blade.php ENDPATH**/ ?>