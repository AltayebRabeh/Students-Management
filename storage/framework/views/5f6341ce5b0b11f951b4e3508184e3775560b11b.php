    ...
    <nav class="vertnav navbar navbar-light">
      ...
      <div class="w-100 mb-4 d-flex">
        <a class="navbar-brand mx-auto mt-2 flex-fill text-center" href="./index.html">
            <img src="<?php echo e(cache('settings') != null ? asset('uploads/'.cache('settings')['logo']) : ''); ?>" alt="Rabeh" width="50px">
        </a>
      </div>
      <ul class="navbar-nav flex-fill w-100 mb-2">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="collapse list-unstyled pl-4 w-100" id="Students">
            <li class="nav-item">
                <a class="nav-link pl-3" href="<?php echo e(route('students.index')); ?>"><span class="ml-1 item-text">عرض الطلاب</span>
                </a>
            </li>
            <li class="nav-item">
              <a class="nav-link pl-3" href="<?php echo e(route('students.create')); ?>"><span class="ml-1 item-text">إضافة طلاب</span>
              </a>
            </li>
            <li class="nav-item">
                <a class="nav-link pl-3" href="<?php echo e(route('archive.index')); ?>"><span class="ml-1 item-text">الارشيف</span>
                </a>
              </li>
          </ul>
        </li>
        ...
        <li class="nav-item dropdown">
            ...
            <ul class="collapse list-unstyled pl-4 w-100" id="supplements">
              <li class="nav-item">
                  <a class="nav-link pl-3" href="<?php echo e(route('supplements.index')); ?>"><span class="ml-1 item-text">ادخال نتيجة</span>
                  </a>
              </li>
              <li class="nav-item">
                <a class="nav-link pl-3" href="<?php echo e(route('supplements.data')); ?>"><span class="ml-1 item-text">عرض نتيجة</span>
                </a>
              </li>
            </ul>
        </li>
        ...
        <li class="nav-item dropdown">
            ...
            <ul class="collapse list-unstyled pl-4 w-100" id="subjectsTeachers">
              <li class="nav-item">
                <a class="nav-link pl-3" href="<?php echo e(route('subjects-teachers.index')); ?>"><span class="ml-1 item-text">عرض المواد والاساتذة</span>
                </a>
              </li>
              <li class="nav-item">
