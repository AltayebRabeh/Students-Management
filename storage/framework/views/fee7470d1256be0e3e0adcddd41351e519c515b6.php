...
<div class="row">
    ...
    <div class="col-md-12 my-4">
        <div class="mb-4">
            <h2 class="h4">إضافة نتيجة الملاحق والبدائل </h2>
        </div>
        <div class="card shadow">
            <div class="card-body">
                <form action="<?php echo e(route('supplements.create')); ?>" id="addSupplements" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Altayeb (Don't tuch)\Students-Management\resources\views/supplements/index.blade.php ENDPATH**/ ?>