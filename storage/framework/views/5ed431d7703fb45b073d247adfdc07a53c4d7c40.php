...
<div class="row">
    ...
    <div class="col-md-12 my-4">
        ...
        <div class="card shadow">
            <div class="card-body">
                <form id="increase" action="<?php echo e(route('grades.increase.success.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/altayeb/Desktop/university/resources/views/grades/increase.blade.php ENDPATH**/ ?>